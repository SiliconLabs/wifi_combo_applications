...
void hardware_setup(void)
{
  ...
  */
  ...
  RSI_PS_UlpssPeriPowerDown(ULPSS_PWRGATE_ULP_CAP | ULPSS_PWRGATE_ULP_UART | ULPSS_PWRGATE_ULP_SSI
                            | ULPSS_PWRGATE_ULP_I2S | ULPSS_PWRGATE_ULP_I2C | ULPSS_PWRGATE_ULP_IR
