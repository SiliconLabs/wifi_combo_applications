...
#define SUBSCRIBE_TO_TOPIC        "wireless_message"   //! Subscribe Topic to receive the message from cloud
#define PUBLISH_ON_TOPIC          "temperature_status" //! Publish Topic to send the status from application to cloud
