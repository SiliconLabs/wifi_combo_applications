...
static const console_descriptive_command_t _wifi_ax_transmit_test_start_command = {
  .description   = "Start the transmit test for Wi-Fi 6. This is a blocking API",
  .argument_help = _wifi_ax_transmit_test_start_arg_help,
  .handler       = sl_wifi_ax_transmit_test_start_command_handler,
  .argument_list = { CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT, CONSOLE_ARG_UINT,
...
static const char *_set_region_configuration_arg_help[] = {
    0,0
};
...
static const console_descriptive_command_t _wifi_radio_deinit = {
    .description = "Wifi radio deinit",
...
static const console_descriptive_command_t _ble_tx_test_mode ={
  .description   = "BLE TX Testmode",
...
static const console_descriptive_command_t _ble_end_test_mode = {
    .description = "BLE End test commands",
...
static const console_descriptive_command_t _ble_per_receive_command = {
  .description   = "Start BLE PER reception",
...
static const console_descriptive_command_t _bt_get_local_name_command = {
  .description   = "Get BLE device name",
  .argument_help = _bt_get_local_name_arg_help,
  .handler       = rsi_bt_get_local_name_command_handler,
  .argument_list = { CONSOLE_ARG_END }
};
...
static const console_descriptive_command_t wifi_reset_command = {
...
static const console_descriptive_command_t _si91x_calibration_read_command = {
  ...
  .argument_list = { CONSOLE_OPTIONAL_ARG('t', CONSOLE_ARG_UINT),
                     CONSOLE_ARG_END }
};
