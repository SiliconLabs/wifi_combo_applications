...
sl_status_t ble_user_gain_table_lp_chain_0dBm_offset_handler(void){//console_args_t *arguments){
  sl_status_t status   = SL_STATUS_OK;
...
sl_status_t ble_user_gain_table_lp_chain_8dBm_offset_handler(void){//console_args_t *arguments){
  sl_status_t status   = SL_STATUS_OK;
...
sl_status_t ble_tx_test_mode_handler(console_args_t *arguments)
{
  ...
  status = rsi_ble_tx_test_mode(ble_tx_channel,
                                ble_tx_phy,
                                ble_tx_payload,
                                ble_tx_payload_type);
...
sl_status_t ble_rx_test_mode_handler(console_args_t *arguments)
{
  sl_status_t status   = SL_STATUS_OK;
    ...
    status = rsi_ble_rx_test_mode(ble_rx_channel,
                                   ble_rx_phy,
                                   RSI_BLE_STANDARD_MODULATION);
