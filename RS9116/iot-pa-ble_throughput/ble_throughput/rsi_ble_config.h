...
#define BT_GLOBAL_BUFF_LEN        20000
...
#define SMP_ENABLE                DISABLED

#define  TX_DATA_LEN              230
/*=======================================================================*/
//! THROUGHPUT TYPE
/*=======================================================================*/
...
#define RSI_APP_BLE_GATT_PROFILES                   0x15
#define RSI_APP_BLE_GATT_CHAR_SERVICES              0x16
#define RSI_APP_BLE_GATT_SERVICE_DESCRIPTOR         0x17
#define RSI_APP_BLE_GATT_SERVICE_RESP_DESCRIPTOR    0x18
#define RSI_APP_BLE_THROGUHPUT_MEASUREMENT          0x29
...
#define CONN_PARAMETER_DATA_LEN     2

#define NOTIFICATION_DATA_LEN       1

#define PHY_DATA_LEN              1

#define THROUGHPUT_RESULT_DATA_LEN  4

#define INDICATION_ENABLE_ATT_VALUE       2

#define NOTIFICATIONS_ENABLE_ATT_VALUE    1
//! error code
...
//  0x04 - Coded PHY
//! Phy parameter
#define TX_PHY_RATE    0x04 // 0x01//0x04
#define RX_PHY_RATE    0x04 // 0x01//0x04
// CODED_PHY_RATE: 0x01
#define CODDED_PHY_RATE 0x01
