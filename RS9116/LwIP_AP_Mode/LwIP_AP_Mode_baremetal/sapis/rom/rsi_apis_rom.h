...
void rsi_assertion(uint16_t assertion_val, const char *string );
  ...
  int32_t   ROM_WL_sendto_async(global_cb_t *global_cb_p, int32_t sockID, int8_t *msg, int32_t msgLength, int32_t flags, struct rsi_sockaddr *destAddr, int32_t destAddrLen, void (*data_transfer_complete_handler)(uint8_t sockID, uint16_t length));
  int32_t   ROM_WL_send(global_cb_t *global_cb_p, int32_t sockID, const int8_t *msg, int32_t msgLength, int32_t flags);
  int32_t   ROM_WL_send_async(global_cb_t *global_cb_p, int32_t sockID, const int8_t *msg, int32_t msgLength, int32_t flags, void (*data_transfer_complete_handler)(uint8_t sockID, uint16_t length));
