...
#define g_ON_OFF_SWITCH_CONFIGURATION_CLUSTER_ENABLE_d                      1
#define g_RSSI_LOCATION_CLUSTER_ENABLE_d                                    1
#define g_BINARY_INPUT_CLUSTER_ENABLE_d                                     1
#define g_DEHUMIDIFICATION_CONTROL_CLUSTER_ENABLE_d                         1
#define g_FAN_CONTROL_CLUSTER_ENABLE_d                                      1
#define g_PUMP_CONFIGURATION_AND_CONTROL_CLUSTER_ENABLE_d                   1
#define g_THERMOSTAT_CLUSTER_ENABLE_d                                       1
#define g_THERMOSTAT_USER_INTERFACE_CONFIG_CLUSTER_ENABLE_d                 1
#define g_COLOR_CONTROL_CLUSTER_ENABLE_d                                    1
#define g_BALLAST_CONFIGURATION_CLUSTER_ENABLE_d                            1
#define g_FLOW_MEASUREMENT_CLUSTER_ENABLE_d                                 1
#define g_ILLUMINANCE_LEVEL_SENSING_CLUSTER_ENABLE_d                        1
#define g_ILLUMINANCE_MEASUREMENT_CLUSTER_ENABLE_d                          1
#define g_OCCUPANCY_SENSING_CLUSTER_ENABLE_d                                1
#define g_PRESSURE_MEASUREMENT_CLUSTER_ENABLE_d                             1
#define g_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER_ENABLE_d                    1
#define g_TEMPERATURE_MEASUREMENT_CLUSTER_ENABLE_d                          1
#define g_IAS_ZONE_CLUSTER_ENABLE_d                                         1
#define g_IAS_ACE_CLUSTER_ENABLE_d                                          1
#define g_IAS_ZONE_CLUSTER_ENABLE_d                                         1
#define g_IAS_WD_CLUSTER_ENABLE_d                                           1
#define g_SHADE_CONFIGURATION_CLUSTER_ENABLE_d                              1
#define g_ZLL_COLOR_CONTROL_CLUSTER_ENABLE_d                                1
#define g_ZLL_BASIC_CLUSTER_ENABLE_d                                        1
#define g_ZLL_IDENTIFY_CLUSTER_ENABLE_d                                     1
#define g_ZLL_ON_OFF_CLUSTER_ENABLE_d                                       1
...
#define g_DOOR_LOCK_CLUSTER_ENABLE_d                          			        1
#define	g_WINDOW_COVERING_CLUSTER_ENABLE_d								                  1
#define g_OTA_BOOTLOAD_CLUSTER_ENABLE_d                                     1 
...
#define g_KEY_ESTABLISHMENT_CLUSTER_ENABLE_d							                  1 
...
#define g_TOU_CALENDER_CLUSTER_ENABLE_d                                     1 
    ...
    #define g_ON_OFF_SWITCH_CONFIGURATION_CLIENT_CLUSTER_ENABLE_d      		1
#else
    #define g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d          	0
...
#if (g_ZLL_BASIC_CLUSTER_ENABLE_d == 1 )
#define g_SW_BUILD_ID_ATTRIBUTE_ENABLE_d  							    1
#endif
#endif
...
#if(g_HA_1_2_d == 1)	
#define g_ON_TRANSITION_TIME_ATTRIBUTE_ENABLE_d							1
#define g_OFF_TRANSITION_TIME_ATTRIBUTE_ENABLE_d						1
#define g_DEFAULT_MOVE_RATE_ATTRIBUTE_ENABLE_d							1
#endif
...
#define g_COLOR_LOOP_START_ENHANCED_HUE_ATTRIBUTE_ENABLE_d              1
#define g_COLOR_LOOP_STORED_ENHANCED_HUE_ATTRIBUTE_ENABLE_d             1
...
#if(g_SCENES_CLUSTER_ENABLE_d==1)
#define g_LAST_CONFIGURED_BY_ATTRIBUTE_ENABLE_d							    1
#define g_SCENE_MGMT_INFO_LAST_CONFIGURED_BY_ATTRIBUTE_ENABLE_d             1
#endif
...
#define g_MAX_DURATION_ATTRIBUTE_ENABLE_d 							1
#define g_ON_DURATION_ATTRIBUTE_ENABLE_d							1
#endif
#endif
/*-----------------------------------------------------------------------------
* End Of File
