...
{
    { g_PD_ENDPOINT_c, (sizeof( a_Server_Cluster_List_For_RE )-1)/ sizeof( App_Cluster_Def_t ),
...
{
    { g_PD_ENDPOINT_c, (sizeof( a_Client_Cluster_List_For_RE )-1)/ sizeof( App_Cluster_Def_t ),
    ...
    if ( status == g_ZCL_Success_c ) {
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                ...
                pRspLocation->asdulength = ZCL_Process_Message( 0x01,
