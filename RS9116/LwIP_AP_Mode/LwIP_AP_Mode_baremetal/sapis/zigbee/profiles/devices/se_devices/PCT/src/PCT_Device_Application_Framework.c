...
const cluster_id_t a_In_Cluster_List_For_PCT[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_PCT[] =
{
...
/* simple descriptor for PCT tool */
const Simple_Descriptor_t PCT_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_PCT_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_PCT) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_PCT,
	sizeof(a_Out_Cluster_List_For_PCT) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_PCT
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&PCT_Simple_Desc, g_PCT_ENDPOINT_c },
};
