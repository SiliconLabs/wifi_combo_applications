...
const cluster_id_t a_In_Cluster_List_For_LCD[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_LCD[] =
{
...
const Simple_Descriptor_t LCD_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_LCD_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_LCD) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_LCD,
	sizeof(a_Out_Cluster_List_For_LCD) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_LCD
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&LCD_Simple_Desc, g_LCD_ENDPOINT_c },
};
