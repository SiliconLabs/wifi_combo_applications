...
#include "PCT_Device.h"
#include "PCT_Device_Application_Framework.h"
...
/* Application cluster definations for PCT for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_PCT[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for PCT for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_PCT[]=
{
...
/* Device definations for PCT Tool for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_PCT_ENDPOINT_c, (sizeof( a_Server_Cluster_List_For_PCT )-1)/ sizeof( App_Cluster_Def_t ),
      a_Server_Cluster_List_For_PCT },
};


/* Device definations for PCT Tool for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_PCT_ENDPOINT_c, (sizeof( a_Client_Cluster_List_For_PCT )-1)/ sizeof( App_Cluster_Def_t ),
      a_Client_Cluster_List_For_PCT }
};
    ...
    if ( status == g_ZCL_Success_c ) {
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                ...
                pRspLocation->asdulength = ZCL_Process_Message( g_PCT_ENDPOINT_c,
