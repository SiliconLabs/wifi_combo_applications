...
#include "LCD_Device_Application_Framework.h"
...
/* Application cluster definations for LCD for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_LCD[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for LCD for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_LCD[]=
{
...
/* Device definations for LCD Tool for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_LCD_ENDPOINT_c, (sizeof( a_Server_Cluster_List_For_LCD )-1)/ sizeof( App_Cluster_Def_t ),
      a_Server_Cluster_List_For_LCD },
};


/* Device definations for LCD Tool for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_LCD_ENDPOINT_c, (sizeof( a_Client_Cluster_List_For_LCD )-1)/ sizeof( App_Cluster_Def_t ),
      a_Client_Cluster_List_For_LCD }
};
                ...
                if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                    ...
                    *pLocationForResponse = g_APSDE_Data_Request_c;
                    ...
                    case g_DRLC_CancelAllLoadControlEvents_c:
                        ...
                        break;
#endif                  /* g_DRLC_CLIENT_CLUSTER_ENABLE_d */
    ...
    if ( status == g_ZCL_Success_c ) {
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                ...
                pRspLocation->asdulength = ZCL_Process_Message( g_LCD_ENDPOINT_c,
