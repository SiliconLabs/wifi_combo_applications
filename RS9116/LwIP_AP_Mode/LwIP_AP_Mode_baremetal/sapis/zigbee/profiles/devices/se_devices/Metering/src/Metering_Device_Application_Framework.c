...
#include "Metering_Device_Application_Framework.h"
...
const cluster_id_t a_In_Cluster_List_For_Metering[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_Metering[] =
{
...
/* simple descriptor for Metering tool */
const Simple_Descriptor_t Metering_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_METERING_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Metering) /sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Metering,
	sizeof(a_Out_Cluster_List_For_Metering) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Metering
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Metering_Simple_Desc, g_METERING_ENDPOINT_c },
};
