...
#include "PD_Device_Application_Framework.h"
...
const cluster_id_t a_In_Cluster_List_For_RE[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_RE[] =
{
...
/* simple descriptor for RE tool */
const Simple_Descriptor_t RE_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_PD_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_RE) /sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_RE,
	sizeof(a_Out_Cluster_List_For_RE) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_RE
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&RE_Simple_Desc, g_PD_ENDPOINT_c },
};
