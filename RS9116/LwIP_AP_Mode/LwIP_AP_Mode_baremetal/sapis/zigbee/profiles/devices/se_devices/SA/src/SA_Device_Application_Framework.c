...
const cluster_id_t a_In_Cluster_List_For_SA[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_SA[] =
{
...
/* simple descriptor for SA tool */
const Simple_Descriptor_t SA_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_SA_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_SA) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_SA,
	sizeof(a_Out_Cluster_List_For_SA) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_SA
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&SA_Simple_Desc, g_SA_ENDPOINT_c },
};
