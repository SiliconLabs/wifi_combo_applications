...
#include "SA_Device.h"
#include "SA_Device_Application_Framework.h"
...
#if ( g_PRICE_INCREASE_RANDOMIZE_MINUTES_ATTRIBUTE_ENABLE_c == 1 ||    \
           g_PRICE_DECREASE_RANDOMIZE_MINUTES_ATTRIBUTE_ENABLE_c == 1|| \
			 g_CLIENT_COMMODITY_TYPE_ATTRIBUTE_ENABLE_c ==1)
...
#if ( g_TIME_ZONE_ATTRIBUTE_ENABLE_c == 1) 	
   g_TIME_ZONE_ATTRIBUTE_DEFAULT_DATA_c,
#endif
#if ( g_TIME_DST_START_ATTRIBUTE_ENABLE_c == 1) 	
    g_TIME_DST_START_ATTRIBUTE_DEFAULT_DATA_c,
#endif
#if ( g_TIME_DST_END_ATTRIBUTE_ENABLE_c == 1) 	
    g_TIME_DST_END_ATTRIBUTE_DEFAULT_DATA_c,
#endif
#if ( g_TIME_DST_SHIFT_ATTRIBUTE_ENABLE_c == 1)
    g_TIME_DST_SHIFT_ATTRIBUTE_DEFAULT_DATA_c,
#endif
#if ( g_TIME_STANDARD_TIME_ATTRIBUTE_ENABLE_c == 1) 	
    g_TIME_STANDARD_TIME_ATTRIBUTE_DEFAULT_DATA_c,
#endif
#if ( g_TIME_LOCAL_TIME_ATTRIBUTE_ENABLE_c == 1) 	
...
/* Application cluster definations for SA for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_SA[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for SA for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_SA[]=
{
   ...
   { &ga_Alarms_Client_Cluster_Info, ZCL_Handle_Alarms_Cluster_Cmd, g_NULL_c, g_NULL_c },
    ...
    { &ga_Commissioning_Client_Cluster_Info, ZCL_Handle_Commissioning_Cluster_Cmd, g_NULL_c,
      g_NULL_c },
#endif
...
/* Device definations for SA Tool for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_SA_ENDPOINT_c, (sizeof( a_Server_Cluster_List_For_SA )-1)/ sizeof( App_Cluster_Def_t ),
      a_Server_Cluster_List_For_SA },
};


/* Device definations for SA Tool for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_SA_ENDPOINT_c, (sizeof( a_Client_Cluster_List_For_SA )-1)/ sizeof( App_Cluster_Def_t ),
      a_Client_Cluster_List_For_SA }
};
    ...
    if ( status == g_ZCL_Success_c ) {
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                ...
                pRspLocation->asdulength = ZCL_Process_Message( g_SA_ENDPOINT_c,
