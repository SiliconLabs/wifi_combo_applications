...
/* Application cluster definations for Metering for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Metering[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Metering for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Metering[]=
{
...
#else
#if ( g_PRICE_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_Price_Client_Cluster_Info, ZCL_Handle_Price_Cluster_Cmd, g_NULL_c,
   g_NULL_c  },
   ...
   { &ga_message_Client_Cluster_Info, ZCL_Handle_Message_Cluster_Cmd, g_NULL_c,
   g_NULL_c  },
#endif                      /* ( g_MESSAGING_CLIENT_CLUSTER_ENABLE_d == 1 ) */
...
/* Device definations for Metering Tool for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_METERING_ENDPOINT_c, (sizeof( a_Server_Cluster_List_For_Metering )-1)/ sizeof( App_Cluster_Def_t ),
      a_Server_Cluster_List_For_Metering },
};


/* Device definations for Metering Tool for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_METERING_ENDPOINT_c, (sizeof( a_Client_Cluster_List_For_Metering )-1)/ sizeof( App_Cluster_Def_t ),
      a_Client_Cluster_List_For_Metering }
};
                    ...
                    if( pActionHandler.action == Send_Response ) {
                        ...
                        if ( ( pIndicationbuffer->cluster_id == g_TIME_CLUSTER_c ) &&
                             ( pIndicationbuffer->a_asdu[ 0x02 ] == g_Read_Attribute_Response_Command_c ) )  {
                                ...
                                if ( App_ProcessTimeReadAttrResponse( &pIndicationbuffer->a_asdu[0x03],
                                                                    pIndicationbuffer->asdulength - 0x03 ) ) {
#if ( g_SIMPLE_METERING_SERVER_CLUSTER_ENABLE_d == 1 )
...
#else
                                uint8_t *seconds;
                                seconds = ZCL_GetTimeAttribueReadRsp( pIndicationbuffer->a_asdu,
                                                               pIndicationbuffer->asdulength );
                                if ( seconds != g_NULL_c ) {
    ...
    if ( status == g_ZCL_Success_c ) {
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ) {
                ...
                pRspLocation->asdulength = ZCL_Process_Message( g_METERING_ENDPOINT_c,
