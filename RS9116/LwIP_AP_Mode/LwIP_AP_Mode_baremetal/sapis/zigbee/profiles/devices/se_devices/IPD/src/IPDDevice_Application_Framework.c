...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_IPD[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_IPD[] =
{
...
/* simple descriptor for IPD tool */
const Simple_Descriptor_t IPD_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_IPD_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_IPD) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_IPD,
	sizeof(a_Out_Cluster_List_For_IPD) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_IPD
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&IPD_Simple_Desc, g_IPD_ENDPOINT_c },
};
