...
const cluster_id_t a_In_Cluster_List_For_PT[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_PT[] =
{
...
/* simple descriptor for Preterminal device tool */
const Simple_Descriptor_t PT_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_PREPAYMENT_TERMINAL_DEVICE_ID_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_PT) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_PT,
	sizeof(a_Out_Cluster_List_For_PT) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_PT
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&PT_Simple_Desc, g_PREPAYMENT_TERMINAL_ENDPOINT_c },
};
