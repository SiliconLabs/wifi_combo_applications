...
#define g_POWER_PROFILE_CLUSTER_ENABLE_d                                0
#define g_APPLIANCE_STATISTICS_CLUSTER_ENABLE_d                         0
#define g_EN50523_APPLIANCE_CONTROL_CLUSTER_ENABLE_d                    0
#define g_EN50523_APPLIANCE_IDENTIFICATION_CLUSTER_ENABLE_d             0
#define g_EN50523_APPLIANCE_EVENTS_AND_ALERTS_CLUSTER_ENABLE_d          0
...
/* Server or Client enabling Macros */
    ...
    #define g_METER_IDENTIFICATION_SERVER_CLUSTER_ENABLE_d                  1
...
#define g_COMPANY_NAME_ATTRIBUTE_ENABLE_c                               1
#define g_METER_TYPE_ID_ATTRIBUTE_ENABLE_c                              1
/* Note : attribute with id 0x0002 0x0003 not defined */
#define g_DATA_QUALITY_ID_ATTRIBUTE_ENABLE_c                            1
#define g_CUSTOMER_NAME_ATTRIBUTE_ENABLE_c                              1
#define g_MODEL_ATTRIBUTE_ENABLE_c                                      1
#define g_PART_NUMBER_ATTRIBUTE_ENABLE_c                                1
#define g_PRODUCTION_REVISION_ATTRIBUTE_ENABLE_c                        1
/* Note : attribute with id 0x0008 not defined */
#define g_SOFTWARE_REVISION_ATTRIBUTE_ENABLE_c                          1
#define g_UTILITY_NAME_ATTRIBUTE_ENABLE_c                               1
/* Point Of Delivery Attribute*/
#define g_POD_ATTRIBUTE_ENABLE_c                                        1
#define g_AVAILABLE_POWER_ATTRIBUTE_ENABLE_c                            1
#define g_THRESHOLD_POWER_ATTRIBUTE_ENABLE_c                            1
