...
#include "SmartPlug_Application_Framework.h"
...
*******************************************************************************/
const cluster_id_t a_In_Cluster_List_For_Smart_Plug[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c
...
const cluster_id_t a_Out_Cluster_List_For_Smart_Plug[] =
{
...
const Simple_Descriptor_t Smart_Plug_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_SMART_PLUG_DEVICE_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Smart_Plug)/	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Smart_Plug,
	sizeof(a_Out_Cluster_List_For_Smart_Plug)/ sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Smart_Plug
};

/******************************************************************************/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Smart_Plug_Simple_Desc,
    g_SMART_PLUG_DEVICE_ENDPOINT_c },
};
