...
/******************************************************************************
* LevelControlSwitchDevice.h
******************************************************************************
* Program Description:
* This file contains the Level Control Switch Device
******************************************************************************/


#ifndef _LEVEL_CONTROL_SWITCH_H_
#define _LEVEL_CONTROL_SWITCH_H_
...
/*lighting domain*/
extern uint8_t m_Hue_Rate;
extern uint8_t m_Lighting_Hue_Data;
extern uint8_t m_Hue_Step_Mode;
extern uint8_t m_Lighting_End_Point;
extern uint8_t m_Saturation_Rate;
extern uint8_t m_Lighting_Saturation_Data;
extern uint8_t m_Saturation_Step_Mode;
...
#endif /* _LEVEL_CONTROL_SWITCH_H_*/
/*-----------------------------------------------------------------------------
* End Of File
*----------------------------------------------------------------------------*/
