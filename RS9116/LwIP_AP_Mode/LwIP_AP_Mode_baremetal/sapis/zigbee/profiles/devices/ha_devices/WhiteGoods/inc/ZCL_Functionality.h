...
/* Server or Client enabling Macros */
    ...
    #define g_POWER_PROFILE_SERVER_CLUSTER_ENABLE_d                     1
    ...
    #define g_APPLIANCE_STATISTICS_SERVER_CLUSTER_ENABLE_d              1
    ...
    #define g_EN50523_APPLIANCE_CONTROL_SERVER_CLUSTER_ENABLE_d              1
    ...
    #define g_EN50523_APPLIANCE_IDENTIFICATION_SERVER_CLUSTER_ENABLE_d      1
    ...
    #define g_EN50523_APPLIANCE_EVENTS_AND_ALERTS_SERVER_CLUSTER_ENABLE_d    1
...
#define g_BASIC_IDENTIFICATION_ATTRIBUTE_ENABLE_c                       1
#define g_APPLIANCE_CLUSTER_COMPANY_NAME_ATTRIBUTE_ENABLE_c             1
#define g_COMPANY_ID_ATTRIBUTE_ENABLE_c                                 1
#define g_BRAND_NAME_ATTRIBUTE_ENABLE_c                                 1
#define g_BRAND_ID_ATTRIBUTE_ENABLE_c                                   1
#define g_APPLIANCE_CLUSTER_MODEL_ATTRIBUTE_ENABLE_c                    1
#define g_APPLIANCE_CLUSTER_PART_NUMBER_ATTRIBUTE_ENABLE_c              1
#define g_PRODUCT_REVISION_ATTRIBUTE_ENABLE_c                           1
#define g_APPLIANCE_CLUSTER_SOFTWARE_REVISION_ATTRIBUTE_ENABLE_c        1
#define g_PRODUCT_TYPE_NAME_ATTRIBUTE_ENABLE_c                          1
#define g_PRODUCT_TYPE_ID_ATTRIBUTE_ENABLE_c                            1
#define g_CECED_SPECIFICATION_VERSION_ATTRIBUTE_ENABLE_c                1
#endif   /* g_EN50523_APPLIANCE_IDENTIFICATION_SERVER_CLUSTER_ENABLE_d == 1*/


#if (g_APPLIANCE_STATISTICS_SERVER_CLUSTER_ENABLE_d == 1)
#define g_LOG_MAX_SIZE_ATTRIBUTE_ENABLE_c                               1
#define g_LOG_QUEUE_MAX_SIZE_ATTRIBUTE_ENABLE_c                         1
#endif     /*g_APPLIANCE_STATISTICS_SERVER_CLUSTER_ENABLE_d == 1*/


#if(g_EN50523_APPLIANCE_CONTROL_SERVER_CLUSTER_ENABLE_d == 1)
//#define g_APPLIANCE_STATUS_ATTRIBUTE_ENABLE_c                           1
//#define g_APPLIANCE_REMOTE_ENABLE_ATTRIBUTE_ENABLE_c                    1
//#define g_APPLIANCE_APPLIANCE_STATUS_2_ATTRIBUTE_ENABLE_c               1

#define g_START_TIME_ATTRIBUTE_ENABLE_c                                 1
#define g_FINISH_TIME_ATTRIBUTE_ENABLE_c                                1
#define g_REMAINING_ATTRIBUTE_ENABLE_c                                  1
#endif     /* g_EN50523_APPLIANCE_CONTROL_SERVER_CLUSTER_ENABLE_d == 1*/


#if ( g_POWER_PROFILE_SERVER_CLUSTER_ENABLE_d == 1 )
#define g_TOTAL_PROFILE_NUMBER_ATTRIBUTE_ENABLE_c                       1
#define g_MULTIPLE_SCHEDULE_ATTRIBUTE_ENABLE_c                          1
#define g_ENERGY_FORMATTING_ATTRIBUTE_ENABLE_c                          1
#define g_ENERGY_REMOTE_ATTRIBUTE_ENABLE_c                              1
#define g_SCHEDULE_MODE_ATTRIBUTE_ENABLE_c                              1
