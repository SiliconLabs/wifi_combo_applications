...
/* Application cluster definations for PumpController Tool for Server */

const App_Cluster_Def_t a_Server_Cluster_List_For_PumpController[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for PumpController for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_PumpController[]=
{
   ...
   { &ga_MS_Flow_Measurement_Client_Cluster_Info, ZCL_Handle_MS_FlowMeasurement_Cluster_Cmd,
     g_NULL_c, g_NULL_c },
#endif                      /* ( g_FLOW_MEASUREMENT_CLUSTER_ENABLE_d == 1 ) */
   ...
   { &ga_Level_Control_Client_Cluster_Info, ZCL_Handle_Level_Control_Cluster_Cmd, g_NULL_c, g_NULL_c },
...
{
    { g_PUMPCONTROLLER_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_PumpController )/
      sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_PumpController }
};


/* Device definations for Client side */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_PUMPCONTROLLER_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_PumpController )/
      sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_PumpController }
};
