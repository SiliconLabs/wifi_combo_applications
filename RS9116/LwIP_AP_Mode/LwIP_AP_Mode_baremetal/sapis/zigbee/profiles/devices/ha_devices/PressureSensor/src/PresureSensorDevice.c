...
/* ZCL Pressure cluster attribute application data strorage  */
...
#if ( g_PRESSURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL Pressure cluster default attribute data */
const Pressure_Measurement_Cluster_t pressure_measurement_server_cluster_default_values =
{
...
/****************************************************************************/
/* Application cluster definations for Pressure sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Pressure_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_MS_Pressure_Measurement_Server_Cluster_Info, ZCL_Handle_MS_PressureMeasurement_Cluster_Cmd,
     &pressure_measurement_server_cluster_values, &pressure_measurement_server_cluster_default_values },
#endif                              /* g_PRESSURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Pressure sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Pressure_Sensor[]=
{
...
/* Device definations for Pressure sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_PRESSURE_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Pressure_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Pressure_Sensor },
};


/* Device definations for Pressure sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_PRESSURE_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Pressure_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Pressure_Sensor },
};
