...
/* ZCL OnOff Switch cluster attribute application data strorage  */
On_Off_Switch_Config_Cluster_t on_off_switch_config_server_cluster_values;
#endif                              /* g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */

#if ( g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL OnOff Switch cluster defaultattribute application data strorage  */
On_Off_Switch_Config_Cluster_t on_off_switch_config_server_cluster_default_values=
{
...
/* Application cluster definations for Simple sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_On_Off_Switch[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_Device_Temp_Config_Server_Cluster_Info, ZCL_Handle_TempConfig_Cluster_Cmd,
    ...
    { &ga_On_Off_Switch_Config_Server_Cluster_Info, ZCL_Handle_OnOff_Switch_Config_Cluster_Cmd,
        &on_off_switch_config_server_cluster_values, &on_off_switch_config_server_cluster_default_values },
#endif                              /* g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for ON OFF SWITCH for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_On_Off_Switch[]=
{
   ...
   { &ga_Group_Client_Cluster_Info,
   ZCL_Handle_Groups_Cluster_Cmd, g_NULL_c, g_NULL_c },
#endif                              /* g_GROUPS_CLIENT_CLUSTER_ENABLE_d */

#if ( g_SCENES_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_Scenes_Client_Cluster_Info,
   ZCL_Handle_Scenes_Cluster_Cmd, g_NULL_c, g_NULL_c },
...
/* Device definations for onoff switch for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_ON_OFF_SWITCH_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_On_Off_Switch )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_On_Off_Switch },
};


/* Device definations for onoff switch for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_ON_OFF_SWITCH_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_On_Off_Switch )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_On_Off_Switch },
};
