...
Level_Control_Cluster_Attributes_t level_control_server_cluster_values;
#endif                              /* g_LEVEL_CONTROL_SERVER_CLUSTER_ENABLE_d */

/* ZCL level control cluster default attribute application data strorage  */
#if( g_LEVEL_CONTROL_SERVER_CLUSTER_ENABLE_d == 1)
const Level_Control_Cluster_Attributes_t level_control_server_cluster_default_values =
{
...
/* ZCL shade configuration cluster attribute application data strorage  */
Shade_Configuration_Cluster_Attributes_t shade_configuration_server_cluster_values;
#endif                  /* g_SHADE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */

#if ( g_SHADE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL shade configuration cluster default attribute application data strorage  */
const Shade_Configuration_Cluster_Attributes_t shade_configuration_server_cluster_default_values=
{
#if ( g_PHYSICAL_CLOSED_LIMIT_ENABLE_d == 1 )
    g_PHYSICAL_CLOSED_LIMIT_ATTRIBUTE_DEFAULT_DATA_c,
#endif                           /* g_PHYSICAL_CLOSED_LIMIT_ENABLE_d */
#if ( g_MOTOR_STEP_SIZE_ENABLE_d == 1 )
    g_MOTOR_STEP_SIZE_ATTRIBUTE_DEFAULT_DATA_c,
#endif                           /* g_MOTOR_STEP_SIZE_ENABLE_d */
    g_STATUS_ATTRIBUTE_DEFAULT_DATA_c,	
    g_CLOSED_LIMIT_ATTRIBUTE_DEFAULT_DATA_c,
    g_MODE_ATTRIBUTE_DEFAULT_DATA_c	
};
#endif                  /* g_SHADE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Shade device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Shade[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if ( g_SHADE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
    { &ga_Shade_Configuration_Cluster_Server_Attribute_info,
    ZCL_Handle_Shade_Config_Cluster_Cmd,&shade_configuration_server_cluster_values,
    &shade_configuration_server_cluster_default_values },
#endif                              /* g_SHADE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Shade for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Shade[]=
{
...
/* Device definations for Shade for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_SHADE_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Shade )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Shade },
};


/* Device definations for Shade for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_SHADE_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Shade )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Shade },
};
