/*******************************************************************************
* ShadeControllerDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for ShadeController device event
*   handling
*******************************************************************************/
...
#include "ShadeControllerDevice.h"
...
/* Application cluster definations for Shade Controller device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Shade_Controller[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Shade controller for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Shade_Controller[]=
{
#if ( g_IDENTIFY_CLIENT_CLUSTER_ENABLE_d == 1 )
    { &ga_Identify_Client_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd,
    g_NULL_c, g_NULL_c},
...
/* Device definations for Shade Controller for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_SHADE_CONTROLLER_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Shade_Controller )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Shade_Controller },
};


/* Device definations for Shade Controller for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_SHADE_CONTROLLER_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Shade_Controller )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Shade_Controller },
};
