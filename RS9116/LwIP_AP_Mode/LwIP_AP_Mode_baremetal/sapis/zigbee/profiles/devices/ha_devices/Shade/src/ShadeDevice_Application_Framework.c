/*******************************************************************************
* ShadeDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Shade device event
*   handling
*******************************************************************************/
...
#include "ShadeDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Shade[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Shade[] =
{
#if ( g_SIMPLE_METERING_CLUSTER_ENABLE_d == 1 )
...
const Simple_Descriptor_t Shade_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_SHADE_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Shade) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Shade,
	sizeof(a_Out_Cluster_List_For_Shade) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Shade
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Shade_Simple_Desc,g_SHADE_ENDPOINT_c },
};
