/*******************************************************************************
* ColorDimmableLightDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Color DimmableLightdevice event
*   handling
*******************************************************************************/
...
#endif          /* BASIC SERVER CLUSTER DEFAULT VALUES */
/******************************************************************/
...
/******************************************************************/
#endif /* POWER CONFIG CLUSTER DEFAULT VALUES */
...
/******************************************************************/
#endif /* DEVICE TEMP CONFIG SERVER CLUSTER DEFAULT VALUES */
...
/******************************************************************/
#endif          /*LEVEL CONTROL SERVER CLUSTER DEFAULT VALUES*/
...
/* SCENES_SERVER_CLUSTER_DEFAULTVALUES */
...
/******************************************************************************/
const App_Cluster_Def_t a_Server_Cluster_List_For_Color_Dimmable_Light[]=
{
 #if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
...
#if(g_COLOR_CONTROL_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Color_Control_Server_Cluster_Info, ZCL_Handle_Color_Ctrl_Cluster_Cmd, &Color_Control_Cluster_server_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Color_Dimmable_Light[]=
{

#if(g_OCCUPANCY_SENSING_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_MS_Occupancy_Sensing_Client_Cluster_Info,ZCL_Handle_MS_OccupancySensing_Cluster_Cmd, g_NULL_c, g_NULL_c},
...
{
    { g_COLOR_DIMMABLE_LIGHT_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Color_Dimmable_Light )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Color_Dimmable_Light },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_COLOR_DIMMABLE_LIGHT_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Color_Dimmable_Light )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Color_Dimmable_Light },
};
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
               ...
               switch ( pActionHandler.event.eventId )
               {
                ...
                case g_Stop_With_On_Off_Event_c:
                    ...
                    Handle_Level_Control_Cluster_Events( &pActionHandler.event,
														p_buffer->dest_endpoint );
					Send_Event_To_Application ( &pActionHandler.event );
                    break;
#endif                              /* g_LEVEL_CONTROL_SERVER_CLUSTER_ENABLE_d */
