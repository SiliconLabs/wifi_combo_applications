...
/* ZCL binary input cluster attribute application data strorage  */
Binary_Input_Cluster_t binary_input_server_cluster_values;
#endif                                  /* g_BINARY_INPUT_SERVER_CLUSTER_ENABLE_d */


#if ( g_BINARY_INPUT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL binary input cluster default attribute data */
const Binary_Input_Cluster_t binary_input_server_cluster_default_values =
{
#if ( g_ACTIVE_TEXT_ATTRIBUTE_ENABLE_d == 1 )
    g_ACTIVE_TEXT_ATTRIBUTE_DEFAULT_DATA_c,
#endif                                  /* g_ACTIVE_TEXT_ATTRIBUTE_ENABLE_d */
#if ( g_DESCRIPTION_ATTRIBUTE_ENABLE_d == 1 )
    g_DESCRIPTION_ATTRIBUTE_DEFAULT_DATA_c,
#endif                                  /* g_DESCRIPTION_ATTRIBUTE_ENABLE_d */
#if ( g_INACTIVE_TEXT_ATTRIBUTE_ENABLE_d == 1 )
    g_INACTIVE_TEXT_ATTRIBUTE_DEFAULT_DATA_c,
#endif                                  /* g_INACTIVE_TEXT_ATTRIBUTE_ENABLE_d */

    g_OUT_OF_SERVICE_ATTRIBUTE_DEFAULT_DATA_c,

#if ( g_POLARITY_ATTRIBUTE_ENABLE_d == 1 )
    g_POLARITY_ATTRIBUTE_DEFAULT_DATA_c,
#endif                                  /* g_POLARITY_ATTRIBUTE_ENABLE_d */

    g_PRESENT_VALUE_ATTRIBUTE_DEFAULT_DATA_c,

#if ( g_RELIABILITY_ATTRIBUTE_ENABLE_d == 1 )
    g_RELIABILITY_ATTRIBUTE_DEFAULT_DATA_c,
#endif                                  /* g_RELIABILITY_ATTRIBUTE_ENABLE_d */

    g_STATUS_FLAGS_ATTRIBUTE_DEFAULT_DATA_c,

#if ( g_APPLICATION_TYPE_ATTRIBUTE_ENABLE_d == 1 )
    g_APPLICATION_TYPE_ATTRIBUTE_DEFAULT_DATA_c
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Simple_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if ( g_BINARY_INPUT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_Binary_Input_Server_Cluster_Info, ZCL_Handle_Binary_Input_Cluster_Cmd,
     &binary_input_server_cluster_values, &binary_input_server_cluster_default_values },
#endif                              /* g_BINARY_INPUT_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for simple sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Simple_Sensor[]=
{
#if ( g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_Simple_metering_Client_Cluster_Info,
   ZCL_Handle_Simple_Metering_Cluster_Cmd, g_NULL_c, g_NULL_c }
#endif                              /* g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d */
};

/* Device definations for simple sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_SIMPLE_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Simple_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Simple_Sensor },
};


/* Device definations for simple sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_SIMPLE_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Simple_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Simple_Sensor },
};
