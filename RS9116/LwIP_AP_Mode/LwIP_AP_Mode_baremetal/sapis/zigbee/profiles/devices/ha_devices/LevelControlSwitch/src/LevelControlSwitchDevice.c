/*******************************************************************************
* LevelControlSwitchDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Level ControlSwitchDevice event
*   handling
*******************************************************************************/
...
#include "LevelControlSwitchDevice.h"
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Level_Control_Switch[]=
{
 #if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd,
   &basic_server_cluster_values,&basic_sever_cluster_default_values },
#endif
#if(g_IDENTIFY_SERVER_CLUSTER_ENABLE_d ==1)
   ...
   ZCL_Handle_PowerConfig_Cluster_Cmd ,&power_config_server_cluster_values,
     &power_config_server_cluster_default_values },
#endif
#if(g_DEVICE_TEMPERATURE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Device_Temp_Config_Server_Cluster_Info,
   ZCL_Handle_TempConfig_Cluster_Cmd, &device_temp_config_server_cluster_values,
...
#if(g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d ==1)
     { &ga_On_Off_Switch_Config_Server_Cluster_Info, ZCL_Handle_OnOff_Cluster_Cmd,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Level_Control_Switch []=
{
...
{
    { g_LEVEL_CONTROL_SWITCH_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Level_Control_Switch )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Level_Control_Switch },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_LEVEL_CONTROL_SWITCH_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Level_Control_Switch )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Level_Control_Switch },
};
