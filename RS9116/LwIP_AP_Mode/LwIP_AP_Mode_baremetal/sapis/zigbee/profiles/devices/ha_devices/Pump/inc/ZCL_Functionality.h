...
#if( g_PRESSURE_MEASUREMENT_CLUSTER_ENABLE_d == 1)
#define g_MS_ATTRIB_PRESSURE_TOLERANCE_ATTRIBUTE_ENABLE_d                   1
#define g_MS_ATTRIB_SCALED_VALUE_ATTRIBUTE_ENABLE_d                         1
#define g_MS_ATTRIB_MIN_SCALED_VALUE_ATTRIBUTE_ENABLE_d                     1
#define g_MS_ATTRIB_MAX_SCALED_VALUE_ATTRIBUTE_ENABLE_d                     1
#define g_MS_ATTRIB_SCALED_TOLERANCE_ATTRIBUTE_ENABLE_d                     1
#define g_MS_ATTRIB_SCALE_ATTRIBUTE_ENABLE_d                                1
#endif
