/*******************************************************************************
* DoorLockControllerDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Door Lock Controller device
*  event handling
*******************************************************************************/
...
#include "DoorLockControllerDevice.h"
...
/* Application cluster definations for Door Lock Controller for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Door_Lock_Controller[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Door Lock Controller for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Door_Lock_Controller[]=
{
   ...
   { &ga_Simple_metering_Client_Cluster_Info, ZCL_Handle_Simple_Metering_Cluster_Cmd,
    g_NULL_c, g_NULL_c},           /* g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d */
#endif
...
/* Device definations for Door lock Controllerfor Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_DOOR_LOCK_CONTROLLER_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Door_Lock_Controller )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Door_Lock_Controller },
};


/* Device definations for Door Lock Controller for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_DOOR_LOCK_CONTROLLER_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Door_Lock_Controller )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Door_Lock_Controller },
};
