...
#include "IAS_CIEDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_IAS_CIE[] = {
...
const cluster_id_t a_Out_Cluster_List_For_IAS_CIE[] = {
...
#endif
#if ( g_IAS_IDENTIFY_CLIENT_CLUSTER_ENABLE_d == 1)
	g_IDENTIFY_CLUSTER_c,
#endif	
...
const Simple_Descriptor_t IAS_CIE_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_IAS_CIE_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_IAS_CIE) / sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_IAS_CIE,
	sizeof(a_Out_Cluster_List_For_IAS_CIE) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_IAS_CIE
};		

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{(Simple_Descriptor_t*)&IAS_CIE_Simple_Desc, g_IAS_CIE_ENDPOINT_c },
};
