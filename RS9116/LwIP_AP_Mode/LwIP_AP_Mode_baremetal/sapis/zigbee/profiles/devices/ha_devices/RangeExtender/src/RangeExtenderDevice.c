/*******************************************************************************
* RangeExtenderDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Range Extenderdevice event
*   handling
*******************************************************************************/
...
/* Application cluster definations for Range Extender for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Range_Extender[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Range Extender for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Range_Extender[]=
{
...
/* Device definations for Range Extender for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_RANGE_EXTENDER_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Range_Extender )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Range_Extender },
};


/* Device definations for Range Extender for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_RANGE_EXTENDER_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Range_Extender )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Range_Extender },
};
