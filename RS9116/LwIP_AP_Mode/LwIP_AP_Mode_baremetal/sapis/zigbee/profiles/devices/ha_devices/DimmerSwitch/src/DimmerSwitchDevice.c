/*******************************************************************************
* DimmerSwitchDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for DimmerSwitch Device event
*   handling
*******************************************************************************/
...
/* Application cluster definations for Dimmer switch for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Dimmer_Switch[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Dimmer switch for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Dimmer_Switch[]=
{
   ...
   { &ga_On_Off_Client_Cluster_Info, ZCL_Handle_Level_Control_Cluster_Cmd,
   g_NULL_c, g_NULL_c },
#endif                  /* g_LEVEL_CONTROL_CLIENT_CLUSTER_ENABLE_d */

#if ( g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_Level_Control_Client_Cluster_Info, ZCL_Handle_Simple_Metering_Cluster_Cmd,
    g_NULL_c, g_NULL_c}
#endif                  /* g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d */
};

/* Device definations for Dimmer switch for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_DIMMER_SWITCH_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Dimmer_Switch )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Dimmer_Switch },
};


/* Device definations for Dimmer switch for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_DIMMER_SWITCH_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Dimmer_Switch )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Dimmer_Switch },
};
                ...
                if( pActionHandler.action == Send_Response ){
                    if ( ( ( * ( pLocationForResponse + g_ZCL_HEADER_COMMAND_OFFSET_c ) == g_Default_Response_Command_c )
                       ...
                       ( * ( pLocationForResponse + g_ZCL_HEADER_COMMAND_OFFSET_c ) == g_Store_Scene_Response_Command_c )
                        ...
                        APS_APSDE_request( rspbufferindex, pAppDataReq );
                  }
               }
