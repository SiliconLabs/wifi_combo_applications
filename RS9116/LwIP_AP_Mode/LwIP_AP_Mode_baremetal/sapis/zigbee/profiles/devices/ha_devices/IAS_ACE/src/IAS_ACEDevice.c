...
/* Application cluster definations for IAS for Server */

const App_Cluster_Def_t a_Server_Cluster_List_For_IAS_ACE[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for IAS for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_IAS_ACE[]=
{
#if ( g_IAS_ACE_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_IAS_ACE_Client_Cluster_Info, ZCL_Handle_IAS_ACE_Cluster_Cmd,
     g_NULL_c, g_NULL_c},
...
{
    { g_IAS_ACE_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_IAS_ACE)/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_IAS_ACE },
};


/* Device definations for IAS for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_IAS_ACE_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_IAS_ACE)/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_IAS_ACE },
};
