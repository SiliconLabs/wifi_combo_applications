/*******************************************************************************
* TemperatureSensorDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for TemperatureSensor device event
*   handling
*******************************************************************************/
...
/* ZCL Temperature cluster attribute application data strorage  */
...
#if ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL Temperature cluster default attribute data */
const Temperature_Measurement_Cluster_t temperature_measurement_server_cluster_default_values =
{
...
#endif						/* g_MS_ATTRIB_TEMPERATURE_TOLERANCE_ATTRIBUTE_ENABLE_d */
...
/* Application cluster definations for Temperature sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Temperature_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_MS_Temperature_Measurement_Server_Cluster_Info, ZCL_Handle_MS_TempMeasurement_Cluster_Cmd,
     &temperature_measurement_server_cluster_values, &temperature_measurement_server_cluster_default_values },
#endif                              /* g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Temperature sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Temperature_Sensor []=
{
...
/* Device definations for Temperature sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_TEMPERATURE_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Temperature_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Temperature_Sensor },
};


/* Device definations for Temperature sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_TEMPERATURE_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Temperature_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Temperature_Sensor },
};
