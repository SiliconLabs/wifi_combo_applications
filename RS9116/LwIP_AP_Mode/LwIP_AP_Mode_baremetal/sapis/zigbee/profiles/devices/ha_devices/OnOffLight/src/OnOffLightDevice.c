...
/* Power configuration cluster Default values*/
#if ( g_POWER_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Device temperature cluster Default values*/
#if ( g_DEVICE_TEMPERATURE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Identify cluster Default value*/
#if ( g_IDENTIFY_SERVER_CLUSTER_ENABLE_d == 1 )
...
#endif                              /* g_ALARM_COUNT_ATTRIBUTE_ENABLE_d */
};
#endif                              /* g_ALARMS_SERVER_CLUSTER_ENABLE_d */

/* Alarm Cluster Default value*/
#if ( g_ALARMS_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Group cluster default values */
#if ( g_GROUPS_SERVER_CLUSTER_ENABLE_d == 1 )
Group_Cluster_t Group_server_cluster_defaul_values =
{
    g_GROUP_ATTRIBUTE_NAME_SUPPORT_ATTRIBUTE_DEFAULT_DATA_c
};
#endif                              /* g_GROUPS_SERVER_CLUSTER_ENABLE_d */
...
/*****************************************************************************/
/* On-off light Server cluster list */
const App_Cluster_Def_t a_Server_Cluster_List_For_On_Off_Light[]=
{
   ...
   { &ga_Group_Server_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd,
        &Group_server_cluster_values, &Group_server_cluster_defaul_values }
#endif                              /* g_GROUPS_SERVER_CLUSTER_ENABLE_d */
...
/* On-off light client cluster list */
const App_Cluster_Def_t a_Client_Cluster_List_For_On_Off_Light []=
{
#if ( g_OCCUPANCY_SENSING_CLIENT_CLUSTER_ENABLE_d == 1)
    { &ga_MS_Occupancy_Sensing_Client_Cluster_Info,
    ZCL_Handle_MS_OccupancySensing_Cluster_Cmd , g_NULL_c, g_NULL_c },
...
{
    { g_ON_OFF_LIGHT_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_On_Off_Light )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_On_Off_Light },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_ON_OFF_LIGHT_ENDPOINT_c,
