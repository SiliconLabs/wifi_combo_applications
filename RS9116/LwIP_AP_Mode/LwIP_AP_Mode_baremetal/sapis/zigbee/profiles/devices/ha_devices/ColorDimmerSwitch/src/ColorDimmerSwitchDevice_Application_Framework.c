/*******************************************************************************
* ColorDimmerSwitchDevice_Application_Framework.c
********************************************************************************
* Program Description:
...
#include "ColorDimmerSwitchDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Color_Dimmer_Switch[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Color_Dimmer_Switch[] =
{
...
const Simple_Descriptor_t Color_Dimmer_Switch_Simple_Desc =
{
	g_APP_PROFILE_ID_c,
	g_COLOR_DIMMER_SWITCH_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Color_Dimmer_Switch)/	sizeof(cluster_id_t),
	(cluster_id_t*)a_In_Cluster_List_For_Color_Dimmer_Switch,
	sizeof(a_Out_Cluster_List_For_Color_Dimmer_Switch)/ sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Color_Dimmer_Switch
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Color_Dimmer_Switch_Simple_Desc, g_COLOR_DIMMER_SWITCH_ENDPOINT_c },
};
