/*******************************************************************************
* FlowSensorDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Flow sensor device event
*   handling
*******************************************************************************/
...
#include "FlowSensorDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Flow_Sensor[] =
{
...
const cluster_id_t a_Out_Cluster_List_For_Flow_Sensor[] =
{
...
/* simple descriptor for Flow Sensor */
const Simple_Descriptor_t Flow_Sensor_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_FLOW_SENSOR_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Flow_Sensor) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Flow_Sensor,
	sizeof(a_Out_Cluster_List_For_Flow_Sensor) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Flow_Sensor
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{(Simple_Descriptor_t*)&Flow_Sensor_Simple_Desc,g_FLOW_SENSOR_ENDPOINT_c },
};
