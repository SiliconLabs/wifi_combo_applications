...
const IAS_Zone_Cluster_t ias_zone_server_cluster_default_data = {
	g_IAS_ZONE_STATE_ATTRIBUTE_DEFAULT_VALUE_c,
	g_IAS_ZONE_TYPE_ATTRIBUTE_DEFAULT_VALUE_c,
	g_IAS_ZONE_STATUS_ATTRIBUTE_DEFAULT_VALUE_c,
	g_IAS_ZONE_IAS_CIE_ADDRESS_ATTRIBUTE_DEFAULT_VALUE_c
};
#endif         /* g_IAS_ZONE_SERVER_CLUSTER_ENABLE_d */

#if ( g_IAS_WD_SERVER_CLUSTER_ENABLE_d == 1 )
IAS_WD_Cluster_t ias_wd_server_cluster_data;

const IAS_WD_Cluster_t ias_wd_server_cluster_default_data = {
	g_IAS_WD_MAX_DURATION_ATTRIBUTE_DEFAULT_VALUE_c
};
#endif         /* g_IAS_ZONE_SERVER_CLUSTER_ENABLE_d */
...
const App_Cluster_Def_t a_Server_Cluster_List_For_IAS_WD[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if ( g_IAS_ZONE_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_IAS_Zone_Server_Cluster_Info, ZCL_Handle_IAS_Zone_Cluster_Cmd,
     &ias_zone_server_cluster_data, &ias_zone_server_cluster_default_data },
#endif                      /* g_IAS_ZONE_CLUSTER_ENABLE_d */

#if ( g_IAS_WD_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_IAS_WD_Server_Cluster_Info, ZCL_Handle_IAS_WD_Cluster_Cmd,
     &ias_wd_server_cluster_data, &ias_wd_server_cluster_default_data },
#endif
...
const App_Cluster_Def_t a_Client_Cluster_List_For_IAS_WD[]= {
...
/* Device definations for WD for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_IAS_WD_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_IAS_WD)/
        sizeof( App_Cluster_Def_t ),a_Server_Cluster_List_For_IAS_WD },
};


/* Device definations for WD for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_IAS_WD_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_IAS_WD )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_IAS_WD },
};
...
#endif	
#if( g_IAS_WD_SERVER_CLUSTER_ENABLE_d == 1 )
                    case g_Start_Warning_Command_Event_c:
				    case g_Squawk_Command_Event_c:
					  Send_Event_To_Application(  &pActionHandler.event);
					 	break;
#endif	
                     default :
