...
/* Application cluster definations for Remote Control device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Remote_Control[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Remote Control device for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Remote_Control[]=
{
...
/* Device definations for Remote Control device for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_REMOTE_CONTROL_ENDPOINT_c,sizeof( a_Server_Cluster_List_For_Remote_Control )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Remote_Control },
};


/* Device definations for Remote Control device for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_REMOTE_CONTROL_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Remote_Control )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Remote_Control },
};
