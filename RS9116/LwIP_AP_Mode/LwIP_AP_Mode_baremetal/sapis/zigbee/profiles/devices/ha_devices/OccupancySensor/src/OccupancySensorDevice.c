/*******************************************************************************
* OccupancySensorDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for OccupancySensor device event
*   handling
*******************************************************************************/
...
/* ZCL Occupancy cluster attribute application data strorage  */
Occupancy_Sensing_Cluster_t occupancy_sensor_server_cluster_values;
#endif                                  /* g_OCCUPANCY_SENSING_SERVER_CLUSTER_ENABLE_d */


#if ( g_OCCUPANCY_SENSING_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL Occupancy cluster default attribute data */
const Occupancy_Sensing_Cluster_t occupancy_sensor_server_cluster_default_values =
{
...
/******************************************************************************/
/* Application cluster definations for Occupancy sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Occupancy_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_MS_Occupancy_Sensing_Server_Cluster_Info, ZCL_Handle_MS_OccupancySensing_Cluster_Cmd,
     &occupancy_sensor_server_cluster_values, &occupancy_sensor_server_cluster_default_values },
#endif                              /* g_OCCUPANCY_SENSING_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Occupancy sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Occupancy_Sensor []=
{
...
/* Device definations for Occupancy sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_OCCUPANCY_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Occupancy_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Occupancy_Sensor },
};


/* Device definations for Occupancy sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_OCCUPANCY_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Occupancy_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Occupancy_Sensor },
};
