...
#include "CombinedInterfaceDevice.h"
...
#endif                                  /* g_DOOR_LOCK_CLUSTER_ENABLE*/
...
/* Application cluster definations for Combined Interface device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Combined_Interface[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Combined Interface device for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Combined_Interface[]=
{
#if ( g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_Basic_Client_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c, g_NULL_c },
#endif                               /* g_BASIC_CLIENT_CLUSTER_ENABLE_d */
   ...
   { &ga_On_Off_Client_Cluster_Info,
   ZCL_Handle_OnOff_Cluster_Cmd, g_NULL_c, g_NULL_c },
   ...
   { &ga_HVAC_Pump_Config_And_Control_Client_Cluster_Info,
   ZCL_Handle_HVAC_PumpConfig_Cluster_Cmd, g_NULL_c, g_NULL_c},
#endif				    /* g_PUMP_CONFIGURATION_AND_CONTROL_CLIENT_CLUSTER_ENABLE_d */

#if(g_SHADE_CONFIGURATION_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Closures_Shade_Configuration_Client_Cluster_Info,
   ZCL_Handle_Shade_Config_Cluster_Cmd, g_NULL_c, g_NULL_c},
#endif				    /* g_SHADE_CONFIGURATION_CLIENT_CLUSTER_ENABLE_d */

#if(g_ON_OFF_SWITCH_CONFIGURATION_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_On_Off_Switch_Config_Client_Cluster_Info,
   ZCL_Handle_OnOff_Switch_Config_Cluster_Cmd, g_NULL_c, g_NULL_c},
#endif				    /* g_ON_OFF_SWITCH_CONFIGURATION_CLIENT_CLUSTER_ENABLE_d */

#if(g_TEMPERATURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_MS_Temperature_Measurement_Client_Cluster_Info,
   ZCL_Handle_MS_TempMeasurement_Cluster_Cmd, g_NULL_c, g_NULL_c},
#endif				    /* g_TEMPERATURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d */

#if(g_ILLUMINANCE_LEVEL_SENSING_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_MS_Illuminance_Level_Sensing_Client_Cluster_Info,
   ZCL_Handle_MS_LevelSensing_Cluster_Cmd, g_NULL_c, g_NULL_c},
#endif				    /* g_ILLUMINANCE_LEVEL_SENSING_CLIENT_CLUSTER_ENABLE_d */

#if(g_ILLUMINANCE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_MS_Illuminance_Measurement_Client_Cluster_Info,
   ZCL_Handle_MS_IlluminanceSensing_Cluster_Cmd, g_NULL_c, g_NULL_c},
   ...
   { &ga_HVAC_Thermostat_User_Interface_Config_Client_Cluster_Info,
   ZCL_Handle_HVAC_TUInterface_Cluster_Cmd,g_NULL_c, g_NULL_c}
#endif                              /* g_THERMOSTAT_USER_INTERFACE_CONFIG_CLIENT_CLUSTER_ENABLE_d */

#if ( g_DOOR_LOCK_CLIENT_CLUSTER_ENABLE_d == 1 )
    ,{ &ga_Door_Lock_Client_Cluster_Info, ZCL_Handle_Closure_Door_Lock_Cmd,
    g_NULL_c, g_NULL_c}
#endif                              /* g_DOOR_LOCK_CLIENT_CLUSTER_ENABLE_d */

#if(g_WINDOW_COVERING_CLIENT_CLUSTER_ENABLE_d == 1)
     ,{ &ga_Windows_Covering_Client_Cluster_Info, ZCL_Handle_Window_Covering_Cluster_Cmd,
    g_NULL_c, g_NULL_c }
#endif                             /* g_WINDOW_COVERING_CLIENT_CLUSTER_ENABLE_d */

#if ( g_THERMOSTAT_CLIENT_CLUSTER_ENABLE_d == 1 )
  , { &ga_HVAC_Thermostat_Client_Cluster_Info, ZCL_Handle_Thermostat_Cluster_Cmd, g_NULL_c, g_NULL_c }
#endif

#if ( g_GROUPS_CLIENT_CLUSTER_ENABLE_d == 1 )
   ,{ &ga_Group_Client_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
#endif

};

/* Device definations for Combined Interface device for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_COMBINED_INTERFACE_ENDPOINT_c,sizeof( a_Server_Cluster_List_For_Combined_Interface )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Combined_Interface },
};


/* Device definations for Combined Interface device for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_COMBINED_INTERFACE_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Combined_Interface )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Combined_Interface },
};
