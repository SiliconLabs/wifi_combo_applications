/*******************************************************************************
* DoorLockControllerDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for DoorLock Controller device event
*   handling
*******************************************************************************/
...
#include "DoorLockControllerDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Door_Lock_Controller[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Door_Lock_Controller[] =
{
...
#if ( g_DOOR_LOCK_CLUSTER_ENABLE_d == 1 )
   g_DOOR_LOCK_CLUSTER_c            /* g_DOOR_LOCK_CLUSTER_ENABLE_d */
#endif

};

/* simple descriptor for Door Lock Controller */
const Simple_Descriptor_t Door_Lock_Controller_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_DOOR_LOCK_CONTROLLER_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Door_Lock_Controller) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Door_Lock_Controller,
	sizeof(a_Out_Cluster_List_For_Door_Lock_Controller) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Door_Lock_Controller
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Door_Lock_Controller_Simple_Desc,
            g_DOOR_LOCK_CONTROLLER_ENDPOINT_c },
};
