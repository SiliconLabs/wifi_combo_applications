/*******************************************************************************
* WhiteGoods_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for White Goods Device
*   handling
*******************************************************************************/
/*******************************************************************************
* Includes
...
#include "WhiteGoods_Application_Framework.h"
...
*******************************************************************************/
const cluster_id_t a_In_Cluster_List_For_White_Goods[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c
...
const cluster_id_t a_Out_Cluster_List_For_White_Goods[] =
{
...
/*simple descriptor for White Goods */
const Simple_Descriptor_t White_Goods_Simple_Desc =
{
	g_APP_PROFILE_ID_c,
	g_WHITE_GOODS_DEVICE_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_White_Goods)/	sizeof(cluster_id_t),
	(cluster_id_t*)a_In_Cluster_List_For_White_Goods,
	sizeof(a_Out_Cluster_List_For_White_Goods)/ sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_White_Goods
};

/******************************************************************************/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&White_Goods_Simple_Desc,
    g_WHITE_GOODS_DEVICE_ENDPOINT_c },
};
