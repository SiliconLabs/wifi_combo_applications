...
#define g_LOCK_STATE_ATTRIBUTE_ENABLE_d                                     1
#define g_LOCK_TYPE_ATTRIBUTE_ENABLE_d                                      1
#define g_ACTUATOR_ENABLED_ATTRIBUTE_ENABLE_d                               1
#define g_DOOR_STATE_ATTRIBUTE_ENABLE_d                                     1
#define g_DOOR_OPEN_EVENTS_ATTRIBUTE_ENABLE_d                               1
#define g_DOOR_CLOSED_EVEVTS_ATTRIBUTE_ENABLE_d                             1
#define g_DOOR_OPEN_PERIOD_ATTRIBUTE_ENABLE_d                               1
#endif
