/*******************************************************************************
* SceneSelectorDevice_Application_Framework.c
********************************************************************************
* Program Description:
...
#include "SceneSelectorDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Scene_Selector[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Scene_Selector[] =
{
#if ( g_IDENTIFY_CLUSTER_ENABLE_d == 1 )
   g_IDENTIFY_CLUSTER_c,
#endif                                  /* g_IDENTIFY_SERVER_CLUSTER_ENABLE_d */
...
const Simple_Descriptor_t Scene_Selector_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_SCENE_SELECTOR_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Scene_Selector) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Scene_Selector,
	sizeof(a_Out_Cluster_List_For_Scene_Selector) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Scene_Selector
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Scene_Selector_Simple_Desc,
        g_SCENE_SELECTOR_ENDPOINT_c },
};
