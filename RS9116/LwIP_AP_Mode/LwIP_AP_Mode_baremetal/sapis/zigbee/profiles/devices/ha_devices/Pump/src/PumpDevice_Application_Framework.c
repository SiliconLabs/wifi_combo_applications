/*******************************************************************************
* PumpDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Pump  Device event
*   handling
*******************************************************************************/
...
#include "PumpDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const static cluster_id_t a_In_Cluster_List_For_Pump[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
#endif
...
const static cluster_id_t a_Out_Cluster_List_For_Pump[] =
{
#if ( g_PRESSURE_MEASUREMENT_CLUSTER_ENABLE_d == 1 )
    g_PRESSURE_MEASUREMENT_CLUSTER_c,
#endif
...
/* simple descriptor for Pump tool */
const static Simple_Descriptor_t Pump_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_PUMP_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Pump) /sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Pump,
	sizeof(a_Out_Cluster_List_For_Pump) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Pump
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{(Simple_Descriptor_t*)&Pump_Simple_Desc, g_PUMP_ENDPOINT_c }
};
