/*******************************************************************************
* ShadeControllerDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Shade Controller device event
*   handling
*******************************************************************************/
...
#include "ShadeControllerDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Shade_Controller[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Shade_Controller[] =
{
#if ( g_IDENTIFY_CLUSTER_ENABLE_d == 1 )
   g_IDENTIFY_CLUSTER_c,
#endif                                  /* g_IDENTIFY_SERVER_CLUSTER_ENABLE_d */
...
const Simple_Descriptor_t Shade_Controller_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_SHADE_CONTROLLER_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Shade_Controller) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Shade_Controller,
	sizeof(a_Out_Cluster_List_For_Shade_Controller) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Shade_Controller
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Shade_Controller_Simple_Desc,
        g_SHADE_CONTROLLER_ENDPOINT_c },
};
