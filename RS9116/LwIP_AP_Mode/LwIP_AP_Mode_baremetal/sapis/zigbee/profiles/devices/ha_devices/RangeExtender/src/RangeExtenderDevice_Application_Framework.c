/*******************************************************************************
* RangeExtenderDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Range Extender device event
*   handling
*******************************************************************************/
...
#include "RangeExtenderDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Range_Extender[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Range_Extender[] =
{
#if ( g_SIMPLE_METERING_CLUSTER_ENABLE_d == 1 )
...
/* simple descriptor for Range Extender*/
const Simple_Descriptor_t Range_Extender_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_RANGE_EXTENDER_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Range_Extender) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Range_Extender,
	sizeof(a_Out_Cluster_List_For_Range_Extender) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Range_Extender
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Range_Extender_Simple_Desc,
            g_RANGE_EXTENDER_ENDPOINT_c },
};
