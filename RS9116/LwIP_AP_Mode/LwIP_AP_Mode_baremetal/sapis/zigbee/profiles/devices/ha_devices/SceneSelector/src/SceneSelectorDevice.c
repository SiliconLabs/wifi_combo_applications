/*******************************************************************************
* SceneSelectorDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for SceneSelector
...
/* Application cluster definations for Scene Selector device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Scene_Selector[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Scene Selector device for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Scene_Selector[]=
{
...
/* Device definations for Scene Selector device for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_SCENE_SELECTOR_ENDPOINT_c,sizeof( a_Server_Cluster_List_For_Scene_Selector )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Scene_Selector },
};


/* Device definations for Scene Selector device for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_SCENE_SELECTOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Scene_Selector )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Scene_Selector },
};
