...
Group_Cluster_t group_server_cluster_default_values =
{
...
Scenes_Cluster_t scene_server_cluster_default_values =
{
...
Door_Lock_Cluster_t Door_Lock_Server_Cluster_Values;
Door_Lock_Cluster_t Door_Lock_Server_Cluster_Default_Values =
{
        g_LOCK_STATE_ATTRIBUTE_DEFAULT_DATA_c,
        g_LOCK_TYPE_ATTRIBUTE_DEFAULT_DATA_c,
        g_ACTUATOR_ENABLED_ATTRIBUTE_DEFAULT_DATA_c,
#if ( g_DOOR_STATE_ATTRIBUTE_ENABLE_d == 1 )
        g_DOOR_STATE_ATTRIBUTE_DEFAULT_DATA_c,
#endif                           /* g_DOOR_STATE_ATTRIBUTE_ENABLE_d */
#if ( g_DOOR_OPEN_EVENTS_ATTRIBUTE_ENABLE_d == 1 )
        g_DOOR_OPEN_EVENTS_ATTRIBUTE_DEFAULT_DATA_c,
#endif                         /* g_DOOR_OPEN_EVENTS_ATTRIBUTE_ENABLE_d*/
#if ( g_DOOR_CLOSED_EVEVTS_ATTRIBUTE_ENABLE_d == 1 )
        g_DOOR_CLOSED_EVENTS_ATTRIBUTE_DEFAULT_DATA_c,
#endif                       /*g_DOOR_CLOSED_EVEVTS_ATTRIBUTE_ENABLE_d*/
#if ( g_DOOR_OPEN_PERIOD_ATTRIBUTE_ENABLE_d == 1 )
        g_OPEN_PERIOD_ATTRIBUTE_DEFAULT_DATA_c
...
/****************************************************************************/
/* Application cluster definations for Door sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Door_Lock[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_Device_Temp_Config_Server_Cluster_Info, ZCL_Handle_TempConfig_Cluster_Cmd,
    ...
    { &ga_Door_Lock_Server_Cluster_Info, ZCL_Handle_Closure_Door_Lock_Cmd,
    &Door_Lock_Server_Cluster_Values, &Door_Lock_Server_Cluster_Default_Values },
...
/* Application cluster definations for Door Lock for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Door_Lock[]=
{
...
/* Device definations for Door lock for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_DOOR_LOCK_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Door_Lock )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Door_Lock },
};


/* Device definations for Door Lock for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_DOOR_LOCK_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Door_Lock )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Door_Lock },
};
...
#if ( DEBUG_TEST == 1 )
		  /* Buffer ID --> 99 */
            allocatedbuffer[rspbufferindex]= 99;
            freebuffer[rspbufferindex][0]= 99;
...
#if ( DEBUG_TEST == 1 )
			  /* Buffer ID --> 92 */
                allocatedbuffer[eventbufferindex]= 92;
                freebuffer[eventbufferindex][0]= 92;
               ...
               switch ( pActionHandler.event.eventId )
               {
	                ...
	                case g_Unlock_Door_Event_c:
						App_DoorLockEventsHandler( &pActionHandler.event, p_buffer );
					break;
#endif				/*g_DOOR_LOCK_SERVER_CLUSTER_ENABLE_d */		
