/*******************************************************************************
* HeatingCoolingUnit.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Heating CoolingUnit device event
*   handling
*******************************************************************************/
...
/* ZCL Fan  Control cluster attribute application data strorage  */
HVAC_Fan_Control_Cluster_Attributes Fan_Control_server_cluster_data;

/* ZCL Fan Control cluster attribute default data strorage  */
...
/* Application cluster definations for HeatingCoolingUnit Tool for Server */

const App_Cluster_Def_t a_Server_Cluster_List_For_HeatingCoolingUnit[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for HeatingCoolingUnit for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_HeatingCoolingUnit[]=
{
...
/* Device definations for HeatingCoolingUnit for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_HEATINGCOOLINGUNIT_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_HeatingCoolingUnit )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_HeatingCoolingUnit }
};


/* Device definations for HeatingCoolingUnit for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_HEATINGCOOLINGUNIT_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_HeatingCoolingUnit )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_HeatingCoolingUnit }
};
