...
/* ZCL Group cluster attribute default data strorage  */
...
/* ZCL Level Control cluster attribute application data strorage  */
Level_Control_Cluster_t level_control_server_cluster_values;

/* ZCL Level Control cluster attribute default data strorage  */
const Level_Control_Cluster_t level_control_server_cluster_default_values =
{
	...
	,g_ON_TRANSITION_TIME_ATTRIBUTE_DEFAULT_DATA_c
#endif
#if(g_OFF_TRANSITION_TIME_ATTRIBUTE_ENABLE_d == 1)
   ,g_OFF_TRANSITION_TIME_ATTRIBUTE_DEFAULT_DATA_c
#endif

#if(g_DEFAULT_MOVE_RATE_ATTRIBUTE_ENABLE_d == 1)
    ,g_DEFAULT_MOVE_RATE_ATTRIBUTE_DEFAULT_DATA_c
#endif
...
/* ZCL On/Off cluster attribute application data strorage  */
On_Off_Cluster_t on_off_cluster_values;

/* ZCL On/Off cluster attribute application data strorage  */
const On_Off_Cluster_t on_off_cluster_default_values =
{
...
Scenes_Cluster_t  Scenes_Cluster_server_default_values = {
...
HVAC_Pump_Configuration_And_Control_Cluster_Attributes
HVAC_Pump_Configuration_And_Control_Server_Cluster_values;

HVAC_Pump_Configuration_And_Control_Cluster_Attributes
HVAC_Pump_Configuration_And_Control_Server_Cluster_default_values =
{
    g_MAX_PRESSURE_ATTRIBUTE_DEFAULT_VALUE_c,	
    g_MAX_SPEED_ATTRIBUTE_DEFAULT_VALUE_c,
    g_MAX_FLOW_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MIN_CONST_PRESSURE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MAX_CONST_PRESSURE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MIN_COMP_PRESSURE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MAX_COMP_PRESSURE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MIN_CONST_SPEED_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MAX_CONST_SPEED_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MIN_CONST_FLOW_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MAX_CONST_FLOW_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MIN_CONST_TEMP_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_MAX_CONST_TEMP_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_PUMP_STATUS_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
    g_EFFECTIVE_OPERATION_MODE_ATTRIBUTE_DEFAULT_VALUE_c,
    g_EFFECTIVE_CONTROL_MODE_ATTRIBUTE_DEFAULT_VALUE_c,
    g_CAPACITY_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_SPEED_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_LIFETIME_RUNNING_HOURS_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_POWER_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_LIFETIME_ENERGY_CONSUMED_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
    g_OPERATION_MODE_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_CONTROL_MODE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_CONST_PRESSURE_ATTRIBUTE_ENABLE_d == 1 )
    g_ALARM_MASK_ATTRIBUTE_DEFAULT_VALUE_c
#endif
};
...
Pressure_Measurement_Cluster_t Pressure_Measurement_Server_Cluster_values;
Pressure_Measurement_Cluster_t Pressure_Measurement_Server_Cluster_default_values =
{
    g_MS_ATTRIB_PRESSURE_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_PRESSURE_MIN_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_PRESSURE_MAX_MEASURED_DEFAULT_VALUE_c
#if ( g_MS_ATTRIB_PRESSURE_TOLERANCE_ATTRIBUTE_ENABLE_d == 1 )
    ,
    g_MS_ATTRIB_PRESSURE_TOLERANCE_DEFAULT_c
#endif
#if ( g_MS_ATTRIB_SCALED_VALUE_ATTRIBUTE_ENABLE_d )
	,
	g_MS_ATTRIB_PRESSURE_SCALED_VALUE_DEFAULT_c
#endif	
#if ( g_MS_ATTRIB_MIN_SCALED_VALUE_ATTRIBUTE_ENABLE_d )
	,
	g_MS_ATTRIB_PRESSURE_MIN_SCALED_VALUE_DEFAULT_c
#endif	
#if ( g_MS_ATTRIB_MAX_SCALED_VALUE_ATTRIBUTE_ENABLE_d )
	 ,
	  g_MS_ATTRIB_PRESSURE_MAX_SCALED_VALUE_DEFAULT_c
#endif	
#if ( g_MS_ATTRIB_SCALED_TOLERANCE_ATTRIBUTE_ENABLE_d )
	,
	g_MS_ATTRIB_PRESSURE_SCALED_TOLERANCE_DEFAULT_c
#endif	
#if ( g_MS_ATTRIB_SCALE_ATTRIBUTE_ENABLE_d )
	  ,
	  g_MS_ATTRIB_PRESSURE_SCALE_DEFAULT_c
#endif	
};
#endif                  /* ( g_PRESSURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */


#if ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
Temperature_Measurement_Cluster_t Temperature_Measurement_Server_Cluster_values;
Temperature_Measurement_Cluster_t Temperature_Measurement_Server_Cluster_default_values =
{
...
Flow_Measurement_Cluster_t Flow_Measurement_Server_Cluster_values;
Flow_Measurement_Cluster_t Flow_Measurement_Server_Cluster_default_values =
{
    g_MS_ATTRIB_FLOW_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_FLOW_MIN_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_FLOW_MAX_MEASURED_DEFAULT_VALUE_c
#if ( g_MS_ATTRIB_FLOW_TOLERANCE_ATTRIBUTE_ENABLE_d == 1 )
    ,
    g_MS_ATTRIB_FLOW_TOLERANCE_DEFAULT_c
#endif                  /* ( g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */
};
#endif
...
/* Application cluster definations for Pump Tool for Server */

const App_Cluster_Def_t a_Server_Cluster_List_For_Pump[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if( g_ON_OFF_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_On_Off_Server_Cluster_Info,ZCL_Handle_OnOff_Cluster_Cmd,&on_off_cluster_values,
   ...
   { &ga_Group_Server_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd, &group_cluster_server_data,
     &group_cluster_server_default_data },
#endif                      /* ( g_GROUPS_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_SCENES_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_Scenes_Server_Cluster_Info, ZCL_Handle_Scenes_Cluster_Cmd, &Scenes_Cluster_server_values,
     &Scenes_Cluster_server_default_values },
#endif                      /* ( g_SCENES_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_PUMP_CONFIGURATION_AND_CONTROL_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_HVAC_Pump_Config_And_Control_Server_Cluster_Info, ZCL_Handle_HVAC_PumpConfig_Cluster_Cmd,
     &HVAC_Pump_Configuration_And_Control_Server_Cluster_values,
     &HVAC_Pump_Configuration_And_Control_Server_Cluster_default_values },
#endif                      /* ( g_PUMP_CONFIGURATION_AND_CONTROL_SERVER_CLUSTER_ENABLE_d == 1 ) */
...
#if ( g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Flow_Measurement_Server_Cluster_Info, ZCL_Handle_MS_FlowMeasurement_Cluster_Cmd,
     &Flow_Measurement_Server_Cluster_values, &Flow_Measurement_Server_Cluster_default_values },
#endif                      /* ( g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_PRESSURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Pressure_Measurement_Server_Cluster_Info, ZCL_Handle_MS_PressureMeasurement_Cluster_Cmd,
     &Pressure_Measurement_Server_Cluster_values,
     &Pressure_Measurement_Server_Cluster_default_values },
#endif                      /* ( g_PRESSURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Temperature_Measurement_Server_Cluster_Info, ZCL_Handle_MS_TempMeasurement_Cluster_Cmd,
     &Temperature_Measurement_Server_Cluster_values,
     &Temperature_Measurement_Server_Cluster_default_values },
#endif                      /* ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */
...
/* Application cluster definations for Pump for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_Pump[]=
{
#if ( g_FLOW_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Flow_Measurement_Client_Cluster_Info, ZCL_Handle_MS_FlowMeasurement_Cluster_Cmd,
     g_NULL_c, g_NULL_c },
#endif                      /* ( g_FLOW_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 ) */

#if ( g_PRESSURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Pressure_Measurement_Client_Cluster_Info, ZCL_Handle_MS_PressureMeasurement_Cluster_Cmd,
     g_NULL_c, g_NULL_c},
#endif                      /* ( g_PRESSURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 ) */
...
/* Device definations for Server side*/
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_PUMP_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Pump )/sizeof( App_Cluster_Def_t ),
      a_Server_Cluster_List_For_Pump }
};


/* Device definations for Pump for Client side */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_PUMP_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Pump )/sizeof( App_Cluster_Def_t ),
      a_Client_Cluster_List_For_Pump }
};
