...
********************************************************************************
* Program Description:
*   This module provides all the functionality for ThermostatDevice event
*   handling
*******************************************************************************/
...
Group_Cluster_t group_cluster_server_data ;

const Group_Cluster_t group_cluster_server_default_data =
...
Scenes_Cluster_t scenes_server_cluster_data;

const Scenes_Cluster_t scenes_server_cluster_default_data =
{
...
HVAC_Thermostat_User_Interface_Configuration_Cluster_Attributes
Thermostat_User_Interface_server_cluster_data;

const HVAC_Thermostat_User_Interface_Configuration_Cluster_Attributes
Thermostat_User_Interface_server_cluster_default_data =
{
   g_TEMPERATURE_DISPLAY_MODE_DEFAULT_VALUE_c,
   g_KEYPAD_LOCKOUT_DEFAULT_VALUE_c
	
#if (g_SCHEDULE_PROGRAMMING_VISIBILTY_ATTRIBUTE_ENABLE_d == 1)
	,g_SCHEDULE_PROGRAMMING_VISIBILTY_DEFAULT_VALUE_c
#endif	
};
#endif
...
HVAC_Thermostat_Cluster_Attributes_t Thermostat_server_cluster_data;

const HVAC_Thermostat_Cluster_Attributes_t Thermostat_server_cluster_default_data =
{
    g_LOCAL_TEMPERATURE_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_OUTDOOR_TEMPERATURE_ATTRIBUTE_ENABLE_d == 1 )
   g_OUTDOOR_TEMPERATURE_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_OCCUPANCY_ATTRIBUTE_ENABLE_d == 1 )
   g_OCCUPANCY_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_ABS_MIN_HEAT_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_ABS_MIN_HEAT_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_ABS_MAX_HEAT_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_ABS_MAX_HEAT_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_ABS_MIN_COOL_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_ABS_MIN_COOL_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_ABS_MAX_COOL_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_ABS_MAX_COOL_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_PI_COOLING_DEMAND_ATTRIBUTE_ENABLE_d == 1 )
   g_PI_COOLING_DEMAND_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_PI_HEATING_DEMAND_ATTRIBUTE_ENABLE_d == 1 )
   g_PI_HEATING_DEMAND_ATTRIBUTE_DEFAULT_VALUE_c,
#endif

#if(g_HA_1_2_d == 1)
#if ( g_HVAC_SYSTEM_TYPE_CONFIGURATION_ATTRIBUTE_ENABLE_d == 1 )
    g_HVAC_SYSTEM_TYPE_CONFIGURATION_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#endif

#if ( g_LOCAL_TEMPERATURE_CALIBRATION_ATTRIBUTE_ENABLE_d == 1 )
   g_LOCAL_TEMPERATURE_CALIBRATION_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
   g_OCCUPIED_COOLING_SET_POINT_ATTRIBUTE_DEFAULT_VALUE_c,
   g_OCCUPIED_HEATING_SET_POINT_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_UN_OCCUPIED_COOLING_SET_POINT_ATTRIBUTE_ENABLE_d == 1 )
  g_UN_OCCUPIED_COOLING_SET_POINT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_UN_OCCUPIED_HEATING_SET_POINT_ATTRIBUTE_ENABLE_d == 1 )
   g_UN_OCCUPIED_HEATING_SET_POINT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MIN_HEAT_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_MIN_HEAT_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_HEAT_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_MAX_HEAT_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MIN_COOL_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_MIN_COOL_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MAX_COOL_SET_POINT_LIMIT_ATTRIBUTE_ENABLE_d == 1 )
   g_MAX_COOL_SET_POINT_LIMIT_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_MIN_SET_POINT_DEAD_BAND_ATTRIBUTE_ENABLE_d == 1 )
   g_MIN_SET_POINT_DEAD_BAND_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
#if ( g_REMOTE_SENSING_ATTRIBUTE_ENABLE_d == 1 )
   g_REMOTE_SENSING_ATTRIBUTE_DEFAULT_VALUE_c,
#endif
   g_CONTROL_SEQUENCE_OF_OPERATION_ATTRIBUTE_DEFAULT_VALUE_c,
   g_SYSTEM_MODE_ATTRIBUTE_DEFAULT_VALUE_c,
#if ( g_THERMOSTAT_ALARM_MASK_ATTRIBUTE_ENABLE_d == 1 )
   g_THERMOSTAT_ALARM_MASK_ATTRIBUTE_DEFAULT_VALUE_c
#endif
#if(g_HA_1_2_d == 1)
#if ( g_THERMOSTAT_RUNNING_MODE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_THERMOSTAT_RUNNING_MODE_ATTRIBUTE_DEFAULT_VALUE_c
#endif

#if ( g_START_OF_WEEK_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_START_OF_WEEK_ATTRIBUTE_DEFAULT_VALUE_c
#endif
#if ( g_NUMBER_OF_WEEKLY_TRANSITIONS_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_NUMBER_OF_WEEKLY_TRANSITIONS_ATTRIBUTE_DEFAULT_VALUE_c
#endif
#if ( g_NUMBER_OF_DAILY_TRANSITIONS_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_NUMBER_OF_DAILY_TRANSITIONS_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_TEMPERATURE_SETPOINT_HOLD_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_TEMPERATURE_SETPOINT_HOLD_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_TEMPERATURE_SETPOINT_HOLD_DURATION_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_TEMPERATURE_SETPOINT_HOLD_DURATION_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_THERMOSTAT_PROGRAMMING_OPERATIONS_MODE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_THERMOSTAT_PROGRAMMING_OPERATIONS_MODE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_THERMOSTAT_RUNNING_STATE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_THERMOSTAT_RUNNING_STATE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_SETPOINT_CHANGE_SOURCE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_SETPOINT_CHANGE_SOURCE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_SETPOINT_CHANGE_AMOUNT_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_SETPOINT_CHANGE_AMOUNT_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_SETPOINT_CHANGE_SOURCE_TIMESTAMP_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_SETPOINT_CHANGE_SOURCE_TIMESTAMP_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_TYPE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_TYPE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_CAPACITY_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_CAPACITY_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_REFRIGERANT_ATTRIBUTE_TYPE_ENABLE_d == 1 )	
	 ,g_AC_REFRIGERANT_TYPE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_COMPRESSOR_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_COMPRESSOR_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_ERROR_CODE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_ERROR_CODE_ATTRIBUTE_DEFAULT_VALUE_c
#endif
#if ( g_AC_LOUVER_POSITION_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_LOUVER_POSITION_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
#if ( g_AC_REFRIGERANT_TYPE_ATTRIBUTE_ENABLE_d == 1 )	
	 ,g_AC_COIL_TEMPERATURE_ATTRIBUTE_DEFAULT_VALUE_c
#endif	
...
HVAC_Fan_Control_Cluster_Attributes Fan_Control_server_cluster_data;

const HVAC_Fan_Control_Cluster_Attributes Fan_Control_server_cluster_default_data =
{
   g_FAN_MODE_DEFAULT_VALUE_c,
   g_FAN_MODE_SEQUENCE_DEFAULT_VALUE_c
};
#endif                      /* g_FAN_CONTROL_SERVER_CLUSTER_ENABLE_d */

#if ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )

Temperature_Measurement_Cluster_t temp_measurement_server_cluster_data ;

const Temperature_Measurement_Cluster_t temp_measurement_server_cluster_default_data =
{
    g_MS_ATTRIB_TEMPERATURE_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_TEMPERATURE_MIN_MEASURED_DEFAULT_VALUE_c,
    g_MS_ATTRIB_TEMPERATURE_MAX_MEASURED_DEFAULT_VALUE_c,
#if ( g_MS_ATTRIB_TEMPERATURE_TOLERANCE_ATTRIBUTE_ENABLE_d == 1 )
    g_MS_ATTRIB_TEMPERATURE_TOLERANCE_DEFAULT_c
#endif
};

#endif                  /* g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */

#if ( g_OCCUPANCY_SENSING_SERVER_CLUSTER_ENABLE_d == 1 )
Occupancy_Sensing_Cluster_t Occupancy_Sensor_Occupancy_Sensing_data;

const Occupancy_Sensing_Cluster_t Occupancy_Sensor_Occupancy_Sensing_default_data =
{
   g_MS_ATTRIB_OCCUPANCY_DEFAULT_DATA_c,
   g_MS_ATTRIB_OCCUPANCY_SENSOR_TYPE_DEFAULT_DATA_c
#if ( g_MS_ATTRIB_PIR_OCCUPIED_TO_UNOCCUPIED_DELAY_ATTRIBUTE_ENABLE_d == 1 )
   ,g_MS_ATTRIB_PIR_OCCUPIED_TO_UNOCCUPIED_DELAY_DEFAULT_DATA_c
#endif
#if ( g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_DELAY_ATTRIBUTE_ENABLE_d == 1 )
   ,g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_DELAY_DEFAULT_DATA_c
#endif
#if	(g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_ATTRIBUTE_ENABLE_d == 1 )
    ,g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_DEFAULT_DATA_c
#endif
#if ( g_MS_ATTRIB_US_OCCUPIED_TO_UNOCCUPIED_DELAY_ATTRIBUTE_ENABLE_d == 1 )
   ,g_MS_ATTRIB_US_OCCUPIED_TO_UNOCCUPIED_DELAY_DEFAULT_DATA_c
#endif
#if ( g_MS_ATTRIB_US_OCCUPIED_TO_UNOCCUPIED_DELAY_ATTRIBUTE_ENABLE_d == 1 )
   ,g_MS_ATTRIB_US_UNOCCUPIED_TO_OCCUPIED_DELAY_DEFAULT_DATA_c
#endif
	
#if ( g_MS_ATTRIB_US_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_ATTRIBUTE_ENABLE_d == 1 )
	,g_MS_ATTRIB_US_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_DEFAULT_DATA_c
#endif
};
...
Humidity_Measurement_Cluster_Attributes humidity_measurement_server_cluster_data ;

const Humidity_Measurement_Cluster_Attributes humidity_measurement_server_cluster_default_data =
{
    m_MS_ATTRIB_HUMIDITY_MEASURED_DEFAULT_VALUE_c,
    m_MS_ATTRIB_HUMIDITY_MIN_MEASURED_DEFAULT_VALUE_c,
    m_MS_ATTRIB_HUMIDITY_MAX_MEASURED_DEFAULT_VALUE_c,
#if ( g_MS_ATTRIB_RELATIVE_TOLERANCE_ATTRIBUTE_ENABLE_d == 1 )
    m_MS_ATTRIB_HUMIDITY_TOLERANCE_DEFAULT_c
#endif
...
/* Application cluster definations for Comfiguration Tool for Server */

const App_Cluster_Def_t a_Server_Cluster_List_For_Thermostat[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_Device_Temp_Config_Server_Cluster_Info, ZCL_Handle_TempConfig_Cluster_Cmd,
     &device_temp_config_server_cluster_values, &device_temp_config_server_cluster_default_values },
#endif                      /* ( g_DEVICE_TEMPERATURE_CONFIGURATION_CLUSTER_ENABLE_d == 1 ) */
...
#if ( g_GROUPS_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_Group_Server_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd, &group_cluster_server_data,
     &scenes_server_cluster_default_data },
#endif                      /* ( g_GROUPS_CLUSTER_ENABLE_d == 1 ) */

#if ( g_SCENES_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_Scenes_Server_Cluster_Info, ZCL_Handle_Scenes_Cluster_Cmd, &scenes_server_cluster_data,
     &scenes_server_cluster_default_data },
#endif                      /* ( g_SCENES_CLUSTER_ENABLE_d == 1 ) */

#if ( g_THERMOSTAT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_HVAC_Thermostat_Server_Cluster_Info, ZCL_Handle_Thermostat_Cluster_Cmd,
     &Thermostat_server_cluster_data, &Thermostat_server_cluster_default_data },
#endif                      /* ( g_THERMOSTAT_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Temperature_Measurement_Server_Cluster_Info, ZCL_Handle_MS_TempMeasurement_Cluster_Cmd,
     &temp_measurement_server_cluster_data, &temp_measurement_server_cluster_default_data },
#endif                      /* ( g_TEMPERATURE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_THERMOSTAT_USER_INTERFACE_CONFIG_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_HVAC_Thermostat_User_Interface_Config_Server_Cluster_Info, ZCL_Handle_HVAC_TUInterface_Cluster_Cmd,
     &Thermostat_User_Interface_server_cluster_data, &Thermostat_User_Interface_server_cluster_default_data },
#endif                      /* ( g_THERMOSTAT_USER_INTERFACE_CONFIG_SERVER_CLUSTER_ENABLE_d == 1 ) */

#if ( g_OCCUPANCY_SENSING_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Occupancy_Sensing_Server_Cluster_Info, ZCL_Handle_MS_OccupancySensing_Cluster_Cmd,
     &Occupancy_Sensor_Occupancy_Sensing_data, &Occupancy_Sensor_Occupancy_Sensing_default_data },
#endif                      /* ( g_OCCUPANCY_SENSING_CLUSTER_ENABLE_d == 1 ) */

#if ( g_FAN_CONTROL_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_HVAC_Fan_Control_Server_Cluster_Info, ZCL_Handle_HVAC_FanControl_Cluster_Cmd,
     &Fan_Control_server_cluster_data, &Fan_Control_server_cluster_default_data },
#endif                      /* g_FAN_CONTROL_SERVER_CLUSTER_ENABLE_d */

#if ( g_RELATIVE_HUMIDITY_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Humidity_Measurement_Server_Cluster_Info, ZCL_Handle_MS_RH_Measurement_Cluster_Cmd,
     &humidity_measurement_server_cluster_data, &humidity_measurement_server_cluster_default_data },
#endif                      /* ( g_RELATIVE_HUMIDITY_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 ) */
...
/* Application cluster definations for Thermostat for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_Thermostat[]=
{
#if ( g_FAN_CONTROL_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_HVAC_Fan_Control_Client_Cluster_Info, ZCL_Handle_HVAC_FanControl_Cluster_Cmd,
     g_NULL_c, g_NULL_c },
#endif                      /* g_FAN_CONTROL_CLIENT_CLUSTER_ENABLE_d */

#if ( g_TEMPERATURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Temperature_Measurement_Client_Cluster_Info, ZCL_Handle_MS_TempMeasurement_Cluster_Cmd,
     g_NULL_c, g_NULL_c  },
#endif                      /* ( g_TEMPERATURE_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 ) */

#if ( g_OCCUPANCY_SENSING_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Occupancy_Sensing_Client_Cluster_Info, ZCL_Handle_MS_OccupancySensing_Cluster_Cmd,
     g_NULL_c, g_NULL_c  },
#endif                      /* ( g_OCCUPANCY_SENSING_CLIENT_CLUSTER_ENABLE_d == 1 ) */

#if ( g_RELATIVE_HUMIDITY_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Humidity_Measurement_Client_Cluster_Info, ZCL_Handle_MS_RH_Measurement_Cluster_Cmd,
     g_NULL_c, g_NULL_c  },
#endif                      /* ( g_RELATIVE_HUMIDITY_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 ) */
...
/* Device definations for Thermostat for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_THREMOSTAT_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Thermostat )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Thermostat },
};


/* Device definations for Thermostat for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_THREMOSTAT_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Thermostat )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Thermostat },
};
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ){
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
               ...
               switch ( pActionHandler.event.eventId )
               {
                    ...
                    case g_Recall_Scene_Command_Event_c:
...
#if( g_THERMOSTAT_SERVER_CLUSTER_ENABLE_d == 1 )
						case g_Heat_Setpoint_Raised_Event_c:
						case g_Heat_Setpoint_Lowered_Event_c:
						case g_Cool_Setpoint_Raised_Event_c:
						case g_Cool_Setpoint_Lowered_Event_c:
#if(g_HA_1_2_d == 1)						
					    case g_Set_Weekly_Schedule_Event_c:
					    case g_Get_Weekly_Schedule_Event_c:
					    case g_Clear_Weekly_Schedule_Event_c:
						 case g_Get_Relay_Status_Log_Event_c:
						App_ThermostatEventsHandler( &pActionHandler.event, p_buffer );
#endif						
						Send_Event_To_Application ( &pActionHandler.event );
						break;
...
#if(g_HA_1_2_d == 1)							
						case g_Current_Weekly_Schedule_Event_c:
						case g_Relay_Status_Log_Event_c:
						App_ThermostatEventsHandler( &pActionHandler.event, p_buffer );
						Send_Event_To_Application ( &pActionHandler.event );
                        break;
#endif						
