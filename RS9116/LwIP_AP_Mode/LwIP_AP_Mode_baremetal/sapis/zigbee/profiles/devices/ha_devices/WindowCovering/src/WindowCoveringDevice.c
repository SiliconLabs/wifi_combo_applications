/*******************************************************************************
* WindowCoveringDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Window Covering device event
*   handling
*******************************************************************************/
...
#include "WindowCoveringDevice.h"
...
/* Application cluster definations for Window covering device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Window_Covering[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#endif
 #if(g_WINDOW_COVERING_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Windows_Covering_Server_Cluster_Info, ZCL_Handle_Window_Covering_Cluster_Cmd,
   &Windows_Covering_Cluster_server_values,&Windows_Covering_Cluster_server_default_values },
#endif
#if ( g_SIMPLE_METERING_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for Window covering for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Window_Covering[]=
{
...
/* Device definations for Window covering for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_WINDOW_COVERING_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Window_Covering )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Window_Covering },
};


/* Device definations for Window covering for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_WINDOW_COVERING_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Window_Covering )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Window_Covering },
};
