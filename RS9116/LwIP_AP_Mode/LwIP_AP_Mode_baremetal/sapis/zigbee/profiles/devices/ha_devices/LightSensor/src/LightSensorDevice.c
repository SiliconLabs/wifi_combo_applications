...
#if ( g_ILLUMINANCE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL illuminance Measurement cluster attribute application data strorage  */
IIluminance_Measurement_Cluster_t illuminance_measurement_server_cluster_values;
#endif                                  /* g_ILLUMINANCE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */


#if ( g_ILLUMINANCE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL illuminance Measurement cluster default attribute data */
const IIluminance_Measurement_Cluster_t illuminance_measurement_server_cluster_default_values =
{
    g_MS_ATTRIB_ILLUMINANCE_MEASURED_VALUE_DEFAULT_VALUE_c,
    g_MS_ATTRIB_ILLUMINANCE_MIN_MEASURED_VALUE_DEFAULT_VALUE_c,
	g_MS_ATTRIB_ILLUMINANCE_MAX_MEASURED_VALUE_DEFAULT_VALUE_c,
	
#if ( g_MS_ATTRIB_ILLUMINANCE_TOLERANCE_ATTRIBUTE_ENABLE_d == 1 )
   g_MS_ATTRIB_ILLUMINANCE_TOLERANCE_DEFAULT_VALUE_c,
	...
	g_MS_ATTRIB_ILLUMINANCE_MEASUREMENT_LIGHT_SENSOR_TYPE_DEFAULT_VALUE_c,
...
/***************************************************************************/
/* Application cluster definations for Light sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Light_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if ( g_ILLUMINANCE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
   { &ga_MS_Illuminance_Measurement_Server_Cluster_Info, ZCL_Handle_MS_IlluminanceSensing_Cluster_Cmd,
     &illuminance_measurement_server_cluster_values, &illuminance_measurement_server_cluster_default_values },
#endif                              /* g_ILLUMINANCE_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for LIght sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Light_Sensor[]=
{
...
/* Device definations for Light sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_LIGHT_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Light_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Light_Sensor },
};


/* Device definations for Light sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_LIGHT_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Light_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Light_Sensor },
};
