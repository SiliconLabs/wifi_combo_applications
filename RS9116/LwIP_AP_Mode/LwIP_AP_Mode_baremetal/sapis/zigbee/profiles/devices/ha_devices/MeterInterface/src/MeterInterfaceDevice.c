/*******************************************************************************
* Meter Interface Device.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Meter Interface Device
*   event handling
*******************************************************************************/
/*******************************************************************************
* Includes
...
#include "MeterInterfaceDevice.h"
...
Meter_Identification_Cluster_t Meter_Identification_server_cluster_values;


const Meter_Identification_Cluster_t
Meter_Identification_server_cluster_default_values = {

#if(g_COMPANY_NAME_ATTRIBUTE_ENABLE_c == 1)
    g_COMPANY_NAME_DEFAULT_DATA_c
#endif

#if(g_METER_TYPE_ID_ATTRIBUTE_ENABLE_c == 1)
    ,g_METER_TYPE_ID_DEFAULT_DATA_c
#endif

#if(g_DATA_QUALITY_ID_ATTRIBUTE_ENABLE_c == 1)
    ,g_DATA_QUALITY_ID_DEFAULT_DATA_c
#endif

#if(g_CUSTOMER_NAME_ATTRIBUTE_ENABLE_c == 1)
    ,g_CUSTOMER_NAME_DEFAULT_DATA_c
#endif

#if(g_MODEL_ATTRIBUTE_ENABLE_c == 1)
    ,g_MODEL_DEFAULT_DATA_c
#endif

#if(g_PART_NUMBER_ATTRIBUTE_ENABLE_c == 1)
    ,g_PART_NUMBER_DEFAULT_DATA_c
#endif

#if(g_PRODUCTION_REVISION_ATTRIBUTE_ENABLE_c == 1)
    ,g_PRODUCT_REVISION_DEFAULT_DATA_c
#endif

#if(g_SOFTWARE_REVISION_ATTRIBUTE_ENABLE_c == 1)
    ,g_SOFTWARE_REVISION_DEFAULT_DATA_c
#endif

#if(g_UTILITY_NAME_ATTRIBUTE_ENABLE_c == 1)
    ,g_UTILITY_NAME_DEFAULT_DATA_c
#endif

#if(g_POD_ATTRIBUTE_ENABLE_c == 1)
    ,g_POD_DEFAULT_DATA_c
#endif

#if(g_AVAILABLE_POWER_ATTRIBUTE_ENABLE_c == 1)
    ,g_AVAILABLE_POWER_DEFAULT_DATA_c
#endif

#if(g_THRESHOLD_POWER_ATTRIBUTE_ENABLE_c == 1)
    ,g_POWER_THRESHOLD_DEFAULT_DATA_c
#endif
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Meter_Interface[]=
{
 #if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
...
#if(g_METER_IDENTIFICATION_SERVER_CLUSTER_ENABLE_d == 1)
   ,{&ga_HA_Meter_Identification_Server_Cluster_Info,
       ZCL_Handle_HA_MeterIdentification_Cluster_Cmd,
       &Meter_Identification_server_cluster_values,
       &Meter_Identification_server_cluster_default_values }
#endif

};

const App_Cluster_Def_t a_Client_Cluster_List_For_Meter_Interface []=
{
   ...
   ,{ &ga_Time_Client_Cluster_Info, ZCL_Handle_Time_Cluster_Cmd, g_NULL_c,
   g_NULL_c  }
...
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    ...
    sizeof( a_Server_Cluster_List_For_Meter_Interface )/
        sizeof( App_Cluster_Def_t ),
        a_Server_Cluster_List_For_Meter_Interface },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_METER_INTERFACE_DEVICE_ENDPOINT_c,
    sizeof( a_Client_Cluster_List_For_Meter_Interface )/
               sizeof( App_Cluster_Def_t ),
               a_Client_Cluster_List_For_Meter_Interface },
};
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
               ...
               switch ( pActionHandler.event.eventId )
               {
                    ...
                    case g_DRLC_CancelAllLoadControlEvents_c:
                        App_DRLCEventsHandler( &pActionHandler.event, p_buffer );
                        break;
                    ...
                    case g_GetScheduledPricesEvent_c :
                        ...
                        App_InterPanPriceEventsHandler( &pActionHandler.event, p_buffer );
#endif
                        break;
                    ...
                    case g_PrepaymentSupplyStatusResEvent_c:
                        App_PrepaymentEventsHandler( &pActionHandler.event, p_buffer );
                        break;
