...
/* Application cluster definations for Configuration Tool for Server */
...
const App_Cluster_Def_t a_Server_Cluster_List_For_IAS_Zone[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
const App_Cluster_Def_t a_Client_Cluster_List_For_IAS_Zone[]=
{
...
/* Device definations for IAS Zone for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_IAS_ZONE_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_IAS_Zone )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_IAS_Zone },
};


/* Device definations for IAS Zone for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_IAS_ZONE_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_IAS_Zone )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_IAS_Zone },
};
