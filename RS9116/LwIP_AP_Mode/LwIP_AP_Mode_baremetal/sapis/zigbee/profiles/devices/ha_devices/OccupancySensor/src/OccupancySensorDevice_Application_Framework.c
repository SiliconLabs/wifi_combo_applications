/*******************************************************************************
* OccupancySensorDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for Occupancy sensor device event
*   handling
*******************************************************************************/
...
#include "OccupancySensorDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_Occupancy_Sensor[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
#endif                                  /* g_BASIC_CLUSTER_ENABLE_d */
...
const cluster_id_t a_Out_Cluster_List_For_Occupancy_Sensor[] =
{
#if ( g_GROUPS_CLUSTER_ENABLE_d == 1 )
    g_GROUPS_CLUSTER_c,
#endif                                  /* g_GROUPS_CLUSTER_ENABLE_d */
...
const Simple_Descriptor_t Occupancy_Sensor_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_OCCUPANCY_SENSOR_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Occupancy_Sensor) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Occupancy_Sensor,
	sizeof(a_Out_Cluster_List_For_Occupancy_Sensor) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Occupancy_Sensor
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{(Simple_Descriptor_t*)&Occupancy_Sensor_Simple_Desc,
            g_OCCUPANCY_SENSOR_ENDPOINT_c },
};
