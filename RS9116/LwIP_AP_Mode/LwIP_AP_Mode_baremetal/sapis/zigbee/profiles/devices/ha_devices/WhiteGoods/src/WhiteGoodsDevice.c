...
Appliance_Identification_Cluster_t appliance_identification_cluster_values;

const Appliance_Identification_Cluster_t appliance_identification_cluster_default_values = {

#if( g_BASIC_IDENTIFICATION_ATTRIBUTE_ENABLE_c == 1)
    g_BASIC_IDENTIFICATION_DEFAULT_DATA_c
#endif

#if( g_APPLIANCE_CLUSTER_COMPANY_NAME_ATTRIBUTE_ENABLE_c == 1)
    ,g_APPLIANCE_CLUSTER_COMPANY_NAME_DEFAULT_DATA_c
#endif

#if( g_COMPANY_ID_ATTRIBUTE_ENABLE_c == 1)
    ,g_COMPANY_ID_DEFAULT_DATA_c
#endif

#if( g_BRAND_NAME_ATTRIBUTE_ENABLE_c == 1)
    ,g_BRAND_NAME_DEFAULT_DATA_c
#endif

#if( g_BRAND_ID_ATTRIBUTE_ENABLE_c == 1)
    ,g_BRAND_ID_DEFAULT_DATA_c
#endif

#if( g_APPLIANCE_CLUSTER_MODEL_ATTRIBUTE_ENABLE_c == 1)
    ,g_APPLIANCE_CLUSTER_MODEL_DEFAULT_DATA_c
#endif

#if( g_APPLIANCE_CLUSTER_PART_NUMBER_ATTRIBUTE_ENABLE_c == 1)
    ,g_APPLIANCE_CLUSTER_PART_NUMBER_DEFAULT_DATA_c
#endif
    ...
    ,g_APPLIANCE_CLUSTER_SOFTWARE_REVISION_DEFAULT_DATA_c
#endif

#if( g_PRODUCT_TYPE_NAME_ATTRIBUTE_ENABLE_c == 1)
    ,g_PRODUCT_TYPE_NAME_DEFAULT_DATA_c
#endif

#if( g_PRODUCT_TYPE_ID_ATTRIBUTE_ENABLE_c == 1)
    ,g_PRODUCT_TYPE_ID_DEFAULT_DATA_c
#endif

#if( g_CECED_SPECIFICATION_VERSION_ATTRIBUTE_ENABLE_c == 1)
    ,g_CECED_SPECIFICATION_VERSION_DEFAULT_DATA_c
#endif
...
Appliance_Statistics_Cluster_t appliance_statistics_cluster_values;

const Appliance_Statistics_Cluster_t appliance_statistics_cluster_default_values = {

#if(g_LOG_MAX_SIZE_ATTRIBUTE_ENABLE_c == 1 )
    g_LOG_MAX_SIZE_DEFAULT_DATA_c
#endif

#if(g_LOG_QUEUE_MAX_SIZE_ATTRIBUTE_ENABLE_c == 1)
    ,g_LOG_QUEUE_MAX_SIZE_DEFAULT_DATA_c
#endif
};
...
Appliance_Control_Cluster_t appliance_control_cluster_values;

const Appliance_Control_Cluster_t appliance_control_cluster_default_values = {

#if( g_START_TIME_ATTRIBUTE_ENABLE_c == 1 )
    g_START_TIME_DEFAULT_DATA_c
#endif

#if( g_FINISH_TIME_ATTRIBUTE_ENABLE_c == 1 )
    ,g_FINISH_TIME_DEFAULT_DATA_c
#endif

#if( g_REMAINING_ATTRIBUTE_ENABLE_c == 1 )
    ,g_REMAINING_TIME_DEFAULT_DATA_c
#endif
...
Power_Profile_Cluster_t power_profile_cluster_values;
const Power_Profile_Cluster_t power_profile_cluster_default_values = {

#if (g_TOTAL_PROFILE_NUMBER_ATTRIBUTE_ENABLE_c == 1)
    g_TOTAL_PROFILE_NUM_DEFAULT_DATA_c
#endif

#if (g_MULTIPLE_SCHEDULE_ATTRIBUTE_ENABLE_c == 1)
    ,g_MULTIPLE_SCHEDULING_DEFAULT_DATA_c
#endif

#if (g_ENERGY_FORMATTING_ATTRIBUTE_ENABLE_c == 1)
    ,g_ENERGY_FORMATTING_DEFAULT_DATA_c
#endif

#if (g_ENERGY_REMOTE_ATTRIBUTE_ENABLE_c == 1)
    ,g_REMOTE_CONTROL_DEFAULT_DATA_c
#endif

#if (g_SCHEDULE_MODE_ATTRIBUTE_ENABLE_c == 1)
    ,g_SCHEDULE_MODE_DEFAULT_DATA_c
#endif
...
const App_Cluster_Def_t a_Server_Cluster_List_For_White_Goods[]=
{
 #if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   ...
   &appliance_identification_cluster_values,
   &appliance_identification_cluster_default_values }
   ...
   &appliance_statistics_cluster_values,
   &appliance_statistics_cluster_default_values }
   ...
   &appliance_control_cluster_values,
   &appliance_control_cluster_default_values }
#endif
...
#if(g_POWER_PROFILE_SERVER_CLUSTER_ENABLE_d == 1)
    ,{&ga_HA_Power_Profile_Server_Cluster_Info,
    ZCL_Handle_HA_Power_Profile_Cluster_Cmd,
    &power_profile_cluster_values,
    &power_profile_cluster_default_values
    }
#endif
...
const App_Cluster_Def_t a_Client_Cluster_List_For_White_Goods []=
{
...
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    ...
    sizeof( a_Server_Cluster_List_For_White_Goods )/
        sizeof( App_Cluster_Def_t ),
        a_Server_Cluster_List_For_White_Goods },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_WHITE_GOODS_DEVICE_ENDPOINT_c,
    sizeof( a_Client_Cluster_List_For_White_Goods )/
               sizeof( App_Cluster_Def_t ),
               a_Client_Cluster_List_For_White_Goods },
};
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
               ...
               switch ( pActionHandler.event.eventId )
               {
                   ...
                   case g_GetAlertsEvent_c:
                        App_ApplianceEventsAndAlertHandler( &pActionHandler.event, p_buffer );
                   break;
