...
IAS_Zone_Cluster_t ias_zone_server_cluster_data;

const IAS_Zone_Cluster_t ias_zone_server_cluster_default_data = {
	g_IAS_ZONE_STATE_DEFAULT_VALUE_c,
	g_IAS_ZONE_TYPE_DEFAULT_VALUE_c,
	g_IAS_ZONE_STATUS_DEFAULT_VALUE_c,
	g_IAS_ZONE_IAS_CIE_ADDRESS_DEFAULT_VALUE_c
};
...
const App_Cluster_Def_t a_Server_Cluster_List_For_IAS_CIE[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
   ...
   { &ga_IAS_ACE_Server_Cluster_Info, ZCL_Handle_IAS_ACE_Cluster_Cmd,
     g_NULL_c, g_NULL_c},
#endif
...
/* Application cluster definations for CIE for Client */

const App_Cluster_Def_t a_Client_Cluster_List_For_IAS_CIE[]=
{

#if ( g_IAS_ZONE_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_IAS_Zone_Client_Cluster_Info, ZCL_Handle_IAS_Zone_Cluster_Cmd,
     g_NULL_c, g_NULL_c},
#endif           /* g_IAS_ZONE_CLUSTER_ENABLE_d */

#if ( g_IAS_WD_CLIENT_CLUSTER_ENABLE_d == 1 )
   { &ga_IAS_WD_Client_Cluster_Info, ZCL_Handle_IAS_WD_Cluster_Cmd,
     g_NULL_c, g_NULL_c},
#endif           /* g_IAS_ZONE_CLUSTER_ENABLE_d */
...
/* Device definations for ACE for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_IAS_CIE_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_IAS_CIE)/
        sizeof( App_Cluster_Def_t ),a_Server_Cluster_List_For_IAS_CIE },
};
...
{
    { g_IAS_CIE_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_IAS_CIE )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_IAS_CIE },
};
...
#if( g_IAS_ACE_SERVER_CLUSTER_ENABLE_d == 1 )
                    case g_Arm_Command_Event_c:
                    case g_ByPass_Command_Event_c:
                    case g_Emergency_Command_Event_c:
                    case g_Fire_Command_Event_c:
                    case g_Panic_Command_Event_c:
                    case g_Get_Zone_Id_Map_Command_Event_c:
                    case g_Get_Zone_Information_Command_Event_c: 					
						Send_Event_To_Application(  &pActionHandler.event);
					break;
					
#endif		/*g_IAS_ACE_SERVER_CLUSTER_ENABLE_d */					
#if( g_IAS_ACE_CLIENT_CLUSTER_ENABLE_d == 1 )
                    case g_Arm_Response_Event_c:
                    case g_Get_Zone_Id_Map_Response_Event_c:
                    case g_Get_Zone_Information_Response_Event_c:					
					Send_Event_To_Application(  &pActionHandler.event);
						break;
#endif         /*g_IAS_ACE_CLIENT_CLUSTER_ENABLE_d */		
#if( g_IAS_ZONE_CLIENT_CLUSTER_ENABLE_d == 1 )
                    case g_Zone_Status_Change_Notification_Command_Event_c:
                    case g_Zone_Enroll_Request_Command_Event_c:  					
					Send_Event_To_Application(  &pActionHandler.event);
					break;
#endif				/*g_IAS_ZONE_CLIENT_CLUSTER_ENABLE_d */			
#if( g_IAS_ZONE_SERVER_CLUSTER_ENABLE_d == 1 )
                    case g_Zone_Enroll_Response_Event_c: 					
					Send_Event_To_Application(  &pActionHandler.event);
                        break;
#endif	  			/*g_IAS_ZONE_SERVER_CLUSTER_ENABLE_d */										
