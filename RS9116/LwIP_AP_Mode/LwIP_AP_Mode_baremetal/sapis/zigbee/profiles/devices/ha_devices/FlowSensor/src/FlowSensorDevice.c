...
/* ZCL FLow Measurement cluster attribute application data strorage  */
Flow_Measurement_Cluster_t flow_measurement_server_cluster_values;
#endif                                  /* g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */


#if ( g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d == 1 )
/* ZCL FLow Measurement cluster default attribute data */
const Flow_Measurement_Cluster_t flow_measurement_server_cluster_default_values =
{
...
/* Application cluster definations for FLow sensor for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_Flow_Sensor[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
/* Application cluster definations for FLow sensor for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_Flow_Sensor[]=
{
...
/* Device definations for FLow sensor for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_FLOW_SENSOR_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Flow_Sensor )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Flow_Sensor },
};


/* Device definations for FLow sensor for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_FLOW_SENSOR_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Flow_Sensor )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Flow_Sensor },
};
