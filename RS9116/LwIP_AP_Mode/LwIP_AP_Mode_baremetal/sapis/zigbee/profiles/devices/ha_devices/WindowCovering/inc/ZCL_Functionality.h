...
#define g_WINDOW_COVERING_CLUSTER_ENABLE_d                              1
#define g_COMMISSIONING_CLUSTER_ENABLE_d              		            0
#define g_DIAGNOSTICS_CLUSTER_ENABLE_d					0
...
/* Server or Client enabling Macros */
    ...
    #define g_WINDOW_COVERING_SERVER_CLUSTER_ENABLE_d                       1
    #define g_WINDOW_COVERING_CLIENT_CLUSTER_ENABLE_d                       0
#else
    #define g_WINDOW_COVERING_SERVER_CLUSTER_ENABLE_d                       0
    #define g_WINDOW_COVERING_CLIENT_CLUSTER_ENABLE_d                       0
#endif
...
#if ( g_OCCUPANCY_SENSING_CLUSTER_ENABLE_d == 1)
#define g_MS_ATTRIB_PIR_OCCUPIED_TO_UNOCCUPIED_DELAY_ATTRIBUTE_ENABLE_d     0
#define g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_DELAY_ATTRIBUTE_ENABLE_d     0
#define	g_MS_ATTRIB_PIR_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_ATTRIBUTE_ENABLE_d		0
#define g_MS_ATTRIB_US_OCCUPIED_TO_UNOCCUPIED_DELAY_ATTRIBUTE_ENABLE_d      0
#define g_MS_ATTRIB_US_UNOCCUPIED_TO_OCCUPIED_DELAY_ATTRIBUTE_ENABLE_d      0
#define g_MS_ATTRIB_US_UNOCCUPIED_TO_OCCUPIED_THRESHOLD_ATTRIBUTE_ENABLE_d	0
#endif
...
#if ( g_WINDOW_COVERING_CLUSTER_ENABLE_d == 1)
#define g_PHYSICAL_CLOSED_LIMIT_LIFT_ATTRIBUTE_ENABLE_d                     1
#define g_PHYSICAL_CLOSED_LIMIT_TILT_ATTRIBUTE_ENABLE_d                     1
#define g_CURRENT_POSITION_LIFT_ATTRIBUTE_ENABLE_d                          1
#define g_CURRENT_POSITION_TILT_ATTRIBUTE_ENABLE_d                          1
#define g_NUMBER_OF_ACTUATIONS_LIFT_ATTRIBUTE_ENABLE_d                      1
#define g_NUMBER_OF_ACTUATIONS_TILT_ATTRIBUTE_ENABLE_d                      1
#define g_CONFIG_STATUS_ATTRIBUTE_ENABLE_d                                  1
#define g_CURRENT_POSITION_LIFT_PERCENTAGE_ATTRIBUTE_ENABLE_d               1
#define g_CURRENT_POSITION_TILT_PERCENTAGE_ATTRIBUTE_ENABLE_d               1
#define g_INSTALLED_OPEN_LIMIT_LIFT_ATTRIBUTE_ENABLE_d                      1
#define g_INSTALLED_CLOSED_LIMIT_LIFT_ATTRIBUTE_ENABLE_d                    1
#define g_INSTALLED_OPEN_LIMIT_TILT_ATTRIBUTE_ENABLE_d                      1
#define g_INSTALLED_CLOSED_LIMIT_TILT_ATTRIBUTE_ENABLE_d                    1
#define g_VELOCITY_LIFT_ATTRIBUTE_ENABLE_d                                  1
#define g_ACCELERATION_TIME_LIFT_ATTRIBUTE_ENABLE_d                         1
#define g_DECELERATION_TIME_LIFT_ATTRIBUTE_ENABLE_d                         1
#define g_MODE_ATTRIBUTE_ENABLE_d                                           1
#define g_INTERMEDIATE_SET_POINTS_LIFT_ATTRIBUTE_ENABLE_d                   1
#define g_INTERMEDIATE_SET_POINTS_TILT_ATTRIBUTE_ENABLE_d                   1
#endif
