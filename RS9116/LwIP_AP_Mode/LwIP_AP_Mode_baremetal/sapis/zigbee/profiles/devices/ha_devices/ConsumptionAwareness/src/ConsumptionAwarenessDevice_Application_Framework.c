...
********************************************************************************
* Program Description:
*   This module provides all the functionality for ColorDimmerSwitchDeviceevent
*   handling
*******************************************************************************/
/*******************************************************************************
* Includes
...
#include "ConsumptionAwarenessDevice_Application_Framework.h"
...
*******************************************************************************/
const cluster_id_t a_In_Cluster_List_For_Consumption_Awareness[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_Consumption_Awareness[] =
{
...
/*simple descriptor for Consumption Awareness*/
const Simple_Descriptor_t Consumption_Awareness_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_CONSUMPTION_AWARENESS_DEVICE_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_Consumption_Awareness)/	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_Consumption_Awareness,
	sizeof(a_Out_Cluster_List_For_Consumption_Awareness)/ sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_Consumption_Awareness
};

/******************************************************************************/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&Consumption_Awareness_Simple_Desc,
    g_CONSUMPTION_AWARENESS_DEVICE_ENDPOINT_c },
};
