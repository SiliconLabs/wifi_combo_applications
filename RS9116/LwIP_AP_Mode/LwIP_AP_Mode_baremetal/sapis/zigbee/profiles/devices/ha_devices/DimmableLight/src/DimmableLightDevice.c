/*******************************************************************************
* DimmableLightDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for dimmable light device event
*   handling
*******************************************************************************/
/*-----------------------------------------------------------------------------
* Includes
...
#if ( g_POWER_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
/* POWER CONFIG CLUSTER DEFAULT VALUES */
...
/* DEVICE TEMP CONFIG SERVER CLUSTER VALUES */
Device_Temp_Config_Cluster_t device_temp_config_server_cluster_values ;

#endif

#if ( g_DEVICE_TEMPERATURE_CONFIGURATION_SERVER_CLUSTER_ENABLE_d == 1 )
/* DEVICE TEMP CONFIG SERVER CLUSTER DEFAULT VALUES */
...
#if(g_ON_OFF_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_On_Off_Server_Cluster_Info,ZCL_Handle_OnOff_Cluster_Cmd,&on_off_cluster_values, &on_off_cluster_default_values },
#endif

#if(g_GROUPS_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Group_Server_Cluster_Info, ZCL_Handle_Groups_Cluster_Cmd, &group_server_cluster_values, &group_server_cluster_default_values },
#endif
...
#endif
                            /* g_SIMPLE_METERING_CLIENT_CLUSTER_ENABLE_d */
};
...
{
    { g_DIMMABLE_LIGHT_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_Dimmable_Light )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_Dimmable_Light },
};

const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_DIMMABLE_LIGHT_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_Dimmable_Light )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_Dimmable_Light },
};
