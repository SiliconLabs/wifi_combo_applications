...
/* Server or Client enabling Macros */
    ...
    #define g_IAS_ZONE_CLIENT_CLUSTER_ENABLE_d                            	1
#else
...
#define g_START_OF_WEEK_ATTRIBUTE_ENABLE_d				1
#define g_NUMBER_OF_WEEKLY_TRANSITIONS_ATTRIBUTE_ENABLE_d		1
#define g_NUMBER_OF_DAILY_TRANSITIONS_ATTRIBUTE_ENABLE_d		1
#define g_TEMPERATURE_SETPOINT_HOLD_ATTRIBUTE_ENABLE_d			1
#define g_TEMPERATURE_SETPOINT_HOLD_DURATION_ATTRIBUTE_ENABLE_d		1
#define g_THERMOSTAT_PROGRAMMING_OPERATIONS_MODE_ATTRIBUTE_ENABLE_d	1

/* HVAC Relay Attribute Set */
#define g_THERMOSTAT_RUNNING_STATE_ATTRIBUTE_ENABLE_d			1

/* Thermostat Setpoint Change Tracking Attribute Set */
#define g_SETPOINT_CHANGE_SOURCE_ATTRIBUTE_ENABLE_d			1
#define g_SETPOINT_CHANGE_AMOUNT_ATTRIBUTE_ENABLE_d			1
#define g_SETPOINT_CHANGE_SOURCE_TIMESTAMP_ATTRIBUTE_ENABLE_d		1

/* AC Information Attribute Set*/

#define g_AC_TYPE_ATTRIBUTE_ENABLE_d					1
#define g_AC_CAPACITY_ATTRIBUTE_ENABLE_d				1
#define g_AC_REFRIGERANT_TYPE_ATTRIBUTE_ENABLE_d                        1
#define g_AC_COMPRESSOR_ATTRIBUTE_ENABLE_d				1
#define g_AC_ERROR_CODE_ATTRIBUTE_ENABLE_d				1
#define g_AC_LOUVER_POSITION_ATTRIBUTE_ENABLE_d				1
#define g_AC_COIL_TEMPERATURE_ATTRIBUTE_ENABLE_d			1
