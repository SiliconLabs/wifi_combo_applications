/*******************************************************************************
* OnOffOutputDevice_Application_Framework.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for OnOFf Output device event
*   handling
*******************************************************************************/
...
#include "OnOffOutputDevice_Application_Framework.h"
...
*----------------------------------------------------------------------------*/
const cluster_id_t a_In_Cluster_List_For_On_Off_Output[] =
{
#if ( g_BASIC_CLUSTER_ENABLE_d == 1 )
   g_BASIC_CLUSTER_c,
...
const cluster_id_t a_Out_Cluster_List_For_On_Off_Output[] =
{
...
/* simple descriptor for On off Output */
const Simple_Descriptor_t On_Off_Output_Simple_Desc =
{	
	g_APP_PROFILE_ID_c,
	g_ON_OFF_OUTPUT_c,
	g_APS_DEVICE_VERSION_FLAGS_c,
    sizeof(a_In_Cluster_List_For_On_Off_Output) /	sizeof(cluster_id_t),	
	(cluster_id_t*)a_In_Cluster_List_For_On_Off_Output,
	sizeof(a_Out_Cluster_List_For_On_Off_Output) / sizeof(cluster_id_t),
	(cluster_id_t*)a_Out_Cluster_List_For_On_Off_Output
};

/*---------------------------------------------------------------------------*/
Endpoint_Description_t  ga_Endpoint_Descriptors[g_MAX_NO_OF_ENDPOINTS_c] =
{
	{ (Simple_Descriptor_t*)&On_Off_Output_Simple_Desc,
            g_ON_OFF_OUTPUT_ENDPOINT_c },
};
