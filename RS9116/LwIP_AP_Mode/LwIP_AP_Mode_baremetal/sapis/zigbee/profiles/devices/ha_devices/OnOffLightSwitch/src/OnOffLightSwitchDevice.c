/*******************************************************************************
* OnOffLightSwitchDevice.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for OnOffLightSwitch Device event
*   handling
*******************************************************************************/
...
/* Application cluster definations for Onoff Light Switch device for Server */
const App_Cluster_Def_t a_Server_Cluster_List_For_On_Off_Light_Switch[]=
{
#if ( g_BASIC_SERVER_CLUSTER_ENABLE_d == 1 )
...
#if(g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d ==1)
     { &ga_On_Off_Switch_Config_Server_Cluster_Info, ZCL_Handle_OnOff_Switch_Config_Cluster_Cmd,
     &on_off_switchconfig_server_cluster_values,
       &on_off_switchconfig_server_cluster_default_values },
#endif                  /* g_ON_OFF_SWITCH_CONFIGURATION_SERVER_CLUSTER_ENABLE_d */
...
/* Application cluster definations for Onoff light switch for Client */
const App_Cluster_Def_t a_Client_Cluster_List_For_On_Off_Light_Switch[]=
{
#if(g_IDENTIFY_CLIENT_CLUSTER_ENABLE_d ==1)
   { &ga_Identify_Server_Cluster_Info, ZCL_Handle_Identify_Cluster_Cmd,g_NULL_c, g_NULL_c },
   ...
   { &ga_On_Off_Client_Cluster_Info, ZCL_Handle_OnOff_Cluster_Cmd, g_NULL_c, g_NULL_c },
...
/* Device definations for onoff light switch for Server */
const ZCL_Device_Def_t AppDeviceListServerInfo[] =
{
    { g_ON_OFF_LIGHT_SWITCH_ENDPOINT_c, sizeof( a_Server_Cluster_List_For_On_Off_Light_Switch )/
        sizeof( App_Cluster_Def_t ), a_Server_Cluster_List_For_On_Off_Light_Switch },
};


/* Device definations for onoff light switch for Client */
const ZCL_Device_Def_t AppDeviceListClientInfo[] =
{
    { g_ON_OFF_LIGHT_SWITCH_ENDPOINT_c, sizeof( a_Client_Cluster_List_For_On_Off_Light_Switch )/
               sizeof( App_Cluster_Def_t ), a_Client_Cluster_List_For_On_Off_Light_Switch },
};
