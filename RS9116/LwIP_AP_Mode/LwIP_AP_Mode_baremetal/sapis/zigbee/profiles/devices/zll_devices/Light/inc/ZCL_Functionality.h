...
/* Additional attributes or commands which is specified by the ZLL profile is
	started with macro prefix with macro ZLL*/
...
/* ZLL commissioning cluster as server is enabled for all Light device type*/
#define g_ZLL_COMMISSIONING_SERVER_CLUSTER_ENABLE_d						1
#define g_ZLL_COMMISSIONING_CLIENT_CLUSTER_ENABLE_d						0
...
#define g_ZLL_IDENTIFY_SERVER_CLUSTER_ENABLE_d                           1
	...
	||(g_COLOR_LIGHT_DEVICE_c == RSI_ENABLE)||(g_EXTENDED_COLOR_LIGHT_DEVICE_c == RSI_ENABLE)\
		||(g_COLOR_TEMPERATURE_LIGHT_DEVICE_c ==RSI_ENABLE) ||                                  \
(g_ON_OFF_LIGHT_DEVICE_c== RSI_ENABLE) || (g_ON_OFF_PLUG_IN_UNIT_DEVICE_c == RSI_ENABLE) )
