/*******************************************************************************
* ZLL_Controller_Device.c
********************************************************************************
* Program Description:
*   This File provides information of all clusters as in and out cluster for
*	every controller device type
*
*******************************************************************************/
/*******************************************************************************
* Includes
...
/******************************************************************/
	...
	/************ Color Controller ********************/
const App_Cluster_Def_t a_Server_Cluster_List_For_Color_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
     &basic_server_cluster_default_values }
#endif
	...
	/* Color Controller - CLient side cluster Info*/
const App_Cluster_Def_t a_Client_Cluster_List_For_Color_Controller[]=
{
#if (g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Client_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
#endif

#if(g_IDENTIFY_CLIENT_CLUSTER_ENABLE_d ==1 )
     /* No attributes at client side*/
    ,{&ga_Identify_Client_Cluster_Info,ZCL_Handle_Identify_Cluster_Cmd,
	g_NULL_c,g_NULL_c}
#endif /* g_IDENTIFY_CLIENT_CLUSTER_ENABLE_d*/

#if (g_LEVEL_CONTROL_CLIENT_CLUSTER_ENABLE_d ==1 )
	,{&ga_Level_Control_Client_Cluster_Info,ZCL_Handle_Level_Control_Cluster_Cmd,
	g_NULL_c,g_NULL_c }
#endif /* g_LEVEL_CONTROL_CLIENT_CLUSTER_ENABLE_d ==1*/
#if(g_GROUPS_CLIENT_CLUSTER_ENABLE_d ==1 )
	,{ &ga_Group_Client_Cluster_Info,ZCL_Handle_Groups_Cluster_Cmd,
	g_NULL_c,g_NULL_c}
#endif /* g_GROUPS_CLIENT_CLUSTER_ENABLE_d ==1 */

#if(g_ON_OFF_CLIENT_CLUSTER_ENABLE_d ==1)
	,{&ga_On_Off_Client_Cluster_Info,ZCL_Handle_OnOff_Cluster_Cmd,
	g_NULL_c,g_NULL_c }
#endif /* g_ON_OFF_CLIENT_CLUSTER_ENABLE_d ==1*/
#if(g_COLOR_CONTROL_CLIENT_CLUSTER_ENABLE_d	== 1)
	,{&ga_Color_Control_Client_Cluster_Info,ZCL_Handle_Color_Ctrl_Cluster_Cmd,
	g_NULL_c,g_NULL_c}
#endif
#if(g_ZLL_COMMISSIONING_CLIENT_CLUSTER_ENABLE_d == 1)
	,{&ga_ZLL_Commissioning_Cluster_Client_Cluster_Info,ZLL_Handle_Commissioning_Cluster_Cmd,
		g_NULL_c,g_NULL_c}
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Color_Scene_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Color_Scene_Controller[]=
{
#if (g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Client_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
	...
	,{&ga_Scenes_Client_Cluster_Info,ZCL_Handle_Scenes_Cluster_Cmd,
	g_NULL_c,g_NULL_c}
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Non_Color_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Non_Color_Controller[]=
{
#if (g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Client_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Non_Color_Scene_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Non_Color_Scene_Controller[]=
{
...
const App_Cluster_Def_t a_Server_Cluster_List_For_Control_Bridge_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_Control_Bridge_Controller[]=
{
#if (g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Client_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
	...
	/****************** On Off Sensor Controller ***********************/

const App_Cluster_Def_t a_Server_Cluster_List_For_On_Off_Sensor_Controller[]=
{
	/* Mandatory Cluster*/
#if (g_BASIC_SERVER_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, &basic_server_cluster_values,
...
const App_Cluster_Def_t a_Client_Cluster_List_For_On_Off_Sensor_Controller[]=
{
#if (g_BASIC_CLIENT_CLUSTER_ENABLE_d == 1)
   { &ga_Basic_Server_Cluster_Info, ZCL_Handle_Basic_Cluster_Cmd, g_NULL_c,
     g_NULL_c }
#endif
...
{
		/* Dummy entry , with endpoint 0xfe*/
    	{0xFe,0x00,g_NULL_c}
/* Atleast one device should be supported*/
#if(g_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE)
    ,{ g_COLOR_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Color_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Color_Controller }
#endif /* g_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE)
	,{ g_COLOR_SCENE_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Color_Scene_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Color_Scene_Controller }
#endif /* g_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_NON_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE)
    ,{ g_NON_COLOR_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Non_Color_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Non_Color_Controller }
#endif /* g_NON_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE)
	,{ g_NON_COLOR_SCENE_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Non_Color_Scene_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Non_Color_Scene_Controller }
#endif /*g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE */
#if( g_CONTROL_BRIDGE_DEVICE_c == RSI_ENABLE)
	,{ g_CONTROL_BRIDGE_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_Control_Bridge_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_Control_Bridge_Controller }
#endif /* g_CONTROL_BRIDGE_DEVICE_c == RSI_ENABLE*/
#if(g_ON_OFF_SENSOR_DEVICE_c == RSI_ENABLE)
    ,{ g_ON_OFF_SENSOR_ENDPOINT_ID_c,
		sizeof( a_Server_Cluster_List_For_On_Off_Sensor_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Server_Cluster_List_For_On_Off_Sensor_Controller }
#endif /* g_ON_OFF_SENSOR_DEVICE_c == RSI_ENABLE*/
	/* No more devices*/
	,{0xfe,0x00,g_NULL_c}
	,{0xfe,0x00,g_NULL_c}
	,{0xfe,0x00,g_NULL_c}
...
#if(g_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE)
   ,{ g_COLOR_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_Color_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_Color_Controller }
#endif /* g_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE)
	,{ g_COLOR_SCENE_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_Color_Scene_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_Color_Scene_Controller }
#endif /* g_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_NON_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE)
    ,{ g_NON_COLOR_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_Non_Color_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_Non_Color_Controller }
#endif /* g_NON_COLOR_CONTROLLER_DEVICE_c == RSI_ENABLE*/
#if(g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE)
	,{ g_NON_COLOR_SCENE_CONTROLLER_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_Non_Color_Scene_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_Non_Color_Scene_Controller }
#endif /*g_NON_COLOR_SCENE_CONTROLLER_DEVICE_c == RSI_ENABLE */
#if( g_CONTROL_BRIDGE_DEVICE_c == RSI_ENABLE)
	,{ g_CONTROL_BRIDGE_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_Control_Bridge_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_Control_Bridge_Controller }
#endif /* g_CONTROL_BRIDGE_DEVICE_c == RSI_ENABLE*/
#if(g_ON_OFF_SENSOR_DEVICE_c == RSI_ENABLE)
    ,{ g_ON_OFF_SENSOR_ENDPOINT_ID_c,
		sizeof( a_Client_Cluster_List_For_On_Off_Sensor_Controller )/
               sizeof( App_Cluster_Def_t ),
			   a_Client_Cluster_List_For_On_Off_Sensor_Controller }
#endif /* g_ON_OFF_SENSOR_DEVICE_c == RSI_ENABLE*/
	/* No more devices*/
	,{0xfe,0x00,g_NULL_c}
	,{0xfe,0x00,g_NULL_c}
        ...
        if( rspbufferindex != g_NO_AVAILABLE_BUFFER_c ){
            ...
            if ( eventbufferindex != g_NO_AVAILABLE_BUFFER_c ){
               ...
               case g_ZLL_Get_Endpoint_List_Req_Event_c:
                    App_Handle_ZLL_Commissioning_Cluster_Events(&pActionHandler.event ,
                                                               p_buffer );
                 break;
