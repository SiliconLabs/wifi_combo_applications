/*******************************************************************************
* ZCL_M_And_S_Flow_Measurement_Cluster.c
********************************************************************************
* Program Description:
*   This module provides all the functionality for supporting Flow measurement
*  cluster
*
*******************************************************************************/
/*-----------------------------------------------------------------------------
...
/* Following are attribute info of g_FLOW_MEASUREMENT_CLUSTER_c */
const ZCL_Attribute_Info_t ma_Flow_Measurement_Cluster_Attribute_info[]=
{
    {  g_MS_ATTRIB_FLOW_MEASURED_VALUE_c,
       g_Unsigned_Sixteen_Bit_Integer_Data_c,
       g_Read_Only_Attribute_c | g_Reportable_Attribute_c },

   {   g_MS_ATTRIB_FLOW_MIN_MEASURED_VALUE_c,
       g_Unsigned_Sixteen_Bit_Integer_Data_c,
       g_Read_Only_Attribute_c },


   {   g_MS_ATTRIB_FLOW_MAX_MEASURED_VALUE_c,
       g_Unsigned_Sixteen_Bit_Integer_Data_c,
       g_Read_Only_Attribute_c  }
#if ( g_MS_ATTRIB_FLOW_TOLERANCE_ATTRIBUTE_ENABLE_d ==  1 )
   ,
   {   g_MS_ATTRIB_FLOW_TOLERANCE_c,
       g_Unsigned_Sixteen_Bit_Integer_Data_c,
       g_Read_Only_Attribute_c | g_Reportable_Attribute_c   }
#endif                          /* g_MS_ATTRIB_FLOW_TOLERANCE_ATTRIBUTE_ENABLE_d */
};

/* Cluster Info for Flow Measurement Server Cluster */
const ZCL_Cluster_Info_t ga_MS_Flow_Measurement_Server_Cluster_Info =
{
    g_FLOW_MEASUREMENT_CLUSTER_c,
    sizeof( ma_Flow_Measurement_Cluster_Attribute_info)/ sizeof( ZCL_Attribute_Info_t ),
    ma_Flow_Measurement_Cluster_Attribute_info
};
#endif                          /* g_FLOW_MEASUREMENT_SERVER_CLUSTER_ENABLE_d */

#if ( g_FLOW_MEASUREMENT_CLIENT_CLUSTER_ENABLE_d == 1 )
/* Cluster Info for Flow Measurement Client Cluster */
const ZCL_Cluster_Info_t ga_MS_Flow_Measurement_Client_Cluster_Info =
{
    g_FLOW_MEASUREMENT_CLUSTER_c,
    g_NULL_c,
    g_NULL_c
