 ...
 *
 *  @brief : This file contains HAL interface layer related function prototypes and defines
 *  @section Description This file contains HAL interface layer related function prototypes and defines
 *
 *
 */
