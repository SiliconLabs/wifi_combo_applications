...
#define RSI_SOCKET_INFO_POOL_ROM_SIZE (sizeof(rsi_socket_info_non_rom_t) * RSI_NUMBER_OF_SOCKETS )


//! Max packet length of BT COMMON tx packet
#define RSI_BT_COMMON_CMD_LEN  300 //TODO Fix it
#define RSI_BT_CLASSIC_CMD_LEN 1040 //300 //TODO Fix it //!(512+16+8+4)
...
#define RSI_WAIT_IN_MS                     10
#define RSI_WAIT_TIME                     RSI_WAIT_FOREVER 
#define RSI_CARD_READY_WAIT_TIME          5000
/******************************************************
 * *                    Constants
 * ******************************************************/
/******************************************************
