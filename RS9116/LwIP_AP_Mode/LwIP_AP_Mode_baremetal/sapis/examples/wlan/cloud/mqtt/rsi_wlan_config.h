...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP   (EXT_FEAT_256K_MODE|EXT_FEAT_SSL_CERT_WITH_4096_KEY_SUPPORT|EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT|EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS)  
