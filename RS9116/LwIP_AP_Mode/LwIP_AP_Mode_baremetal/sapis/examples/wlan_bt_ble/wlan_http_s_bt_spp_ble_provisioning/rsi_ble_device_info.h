...
typedef struct rsi_ble_conn_info_s{
	...
	rsi_ble_event_remote_conn_param_req_t  	rsi_app_remote_device_conn_params; 				//! -- rsi_ble_on_remote_conn_params_request_event()
	rsi_ble_event_conn_status_t       		conn_event_to_app;  							//! -- rsi_ble_on_connect_event()  rsi_ble_on_disconnect_event() rsi_ble_on_enhance_conn_status_event()
