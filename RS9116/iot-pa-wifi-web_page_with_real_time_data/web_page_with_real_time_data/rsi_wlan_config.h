...
#define RSI_FEATURE_BIT_MAP (FEAT_SECURITY_PSK | FEAT_AGGREGATION)

//! TCP IP BYPASS feature check
#define RSI_TCP_IP_BYPASS RSI_DISABLE

//! TCP/IP feature select bitmap for selecting TCP/IP features
#define RSI_TCP_IP_FEATURE_BIT_MAP (TCP_IP_FEAT_DHCPV4_CLIENT |  TCP_IP_FEAT_HTTP_SERVER | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_SNTP_CLIENT)

//! To set custom feature select bit map
#define RSI_CUSTOM_FEATURE_BIT_MAP  CUSTOM_FEAT_DUAL_BAND_ROAM_VCSAFD
...
//! To set Extended TCP/IP feature select bit map
...
#define RSI_JOIN_FEAT_BIT_MAP RSI_JOIN_FEAT_PS_CMD_LISTEN_INTERVAL_VALID
