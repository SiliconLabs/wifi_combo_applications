...
#define RECEIVED_REQ_DATA_LEN 8

#define FIRST_ITERATION 1
#define SECOND_ITERATION 2
#define THIRD_ITERATION 3
...
#define ADV_FLAGS_DATA_LENGTH 13
...
#define RSI_APP_BLE_MTU_EVENT 2
#define RSI_APP_BLE_GATT_PROFILES 3
#define RSI_APP_BLE_GATT_CHAR_SERVICES 4
#define RSI_APP_BLE_GATT_SERVICE_DESCRIPTOR 5
#define RSI_APP_BLE_GATT_SERVICE_RESP_DESCRIPTOR 6
#define RSI_APP_BLE_GATT_WRITE_EVENT 7
#define RSI_APP_INCOMING_CALL_INFORMATION 8
#define RSI_BLE_SMP_REQ_EVENT 9
#define RSI_BLE_SMP_RSP_EVENT 10
#define RSI_BLE_SMP_FAILED_EVENT 11
#define RSI_BLE_ENCRYPT_STARTED_EVENT 12
#define RSI_BLE_LTK_REQ_EVENT 13
#define RSI_BLE_SMP_PASSKEY_EVENT 14
#define RSI_BLE_SMP_PASSKEY_DISPLAY_EVENT 15
#define RSI_BLE_SC_PASSKEY_EVENT 16

/*=======================================================================*/
//! ANCS notifications category ID field
/*=======================================================================*/
...
/*=======================================================================*/
//! ANCS notifications Command ID field
/*=======================================================================*/
#define GET_NOTIFICATION_ATTRIBUTE 0x00

#define CMD_ID_LEN 0x02

/*=======================================================================*/
//! missed call information
/*=======================================================================*/
#define APP_IDENTIFIER 0
#define TITLE 1
#define TITLE_LEN 0x000F
#define ID_LEN 1
#define NOTIFICATION_ID_LEN 4
#define INCOMING_CALL_REQ_LEN 9
#define NEXT_HANDLE 1
...
#define RSI_FEATURE_BIT_MAP                                                    \
  (FEAT_ULP_GPIO_BASED_HANDSHAKE |                                             \
   FEAT_DEV_TO_HOST_ULP_GPIO_1)       //! To set wlan feature select bit map
#define RSI_TCP_IP_BYPASS RSI_DISABLE //! TCP IP BYPASS feature check
#define RSI_TCP_IP_FEATURE_BIT_MAP                                             \
  (TCP_IP_FEAT_DHCPV4_CLIENT) //! TCP/IP feature select bitmap for selecting
                              //! TCP/IP features
#define RSI_EXT_TCPIP_FEATURE_BITMAP 0

#define RSI_CUSTOM_FEATURE_BIT_MAP                                             \
  FEAT_CUSTOM_FEAT_EXTENTION_VALID //! To set custom feature select bit map

#ifdef WISECONNECT
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                         \
  (EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | EXT_FEAT_384K_MODE)
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                         \
...
//! Min Value = 2048 bytes; Max Value = 4096 bytes; Value should be in multiples
//! of 512 bytes
