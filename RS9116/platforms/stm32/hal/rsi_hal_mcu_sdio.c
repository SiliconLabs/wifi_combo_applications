...
{
	UNUSED_PARAMETER(tx_data);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(Addr);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(no_of_blocks);//This statement is added only to resolve compilation warning, value is unchanged
...
{
	UNUSED_PARAMETER(read_buff);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(Addr);//This statement is added only to resolve compilation warning, value is unchanged
    return 0;
}
...
{
	UNUSED_PARAMETER(dBuf);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(Addr);//This statement is added only to resolve compilation warning, value is unchanged
    return 0;
}
...
int16_t rsi_sdio_readb(uint32_t addr, uint16_t len, uint8_t *dBuf)
{
	UNUSED_PARAMETER(dBuf);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(addr);//This statement is added only to resolve compilation warning, value is unchanged
	UNUSED_PARAMETER(len);//This statement is added only to resolve compilation warning, value is unchanged
	return 0;
}
