...
typedef enum rsi_wlan_app_state_e {
  ...
  RSI_WLAN_SCAN_STATE                = 4,
  RSI_WLAN_JOIN_STATE                = 5,
  RSI_WLAN_SOCKET_RECEIVE_STATE      = 6,
  RSI_WLAN_MQTT_INIT_DONE_STATE      = 7,
  RSI_WLAN_MQTT_SUBSCRIBE_DONE_STATE = 8,
  RSI_BLE_GATT_WRITE_EVENT           = 9,
  RSI_WLAN_DISCONNECTED_STATE        = 10,
  RSI_WLAN_DISCONN_NOTIFY_STATE      = 11,
  RSI_WLAN_ERROR_STATE               = 12,
  RSI_WLAN_FLASH_STATE               = 13,
  RSI_WLAN_DATA_RECEIVE_STATE        = 14,
  RSI_SD_WRITE_STATE                 = 15,
  RSI_WLAN_DEMO_COMPLETE_STATE       = 16
