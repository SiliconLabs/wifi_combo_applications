...
#define RSI_FEATURE_BIT_MAP (FEAT_SECURITY_OPEN | BIT(2) | BIT(4))
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP (BIT(16) | EXT_TCP_IP_FEAT_SSL_MEMORY_CLOUD | BIT(31))
...
#define WIRELESS_MODE 0 //! HP mode - 0 ;LP mode - 12
#define ENABLE_PPP    0
#define AFE_TYPE      1
...
//! Beacon missed count
#define RSI_REJOIN_BEACON_MISSED_COUNT 80 //!8secs
