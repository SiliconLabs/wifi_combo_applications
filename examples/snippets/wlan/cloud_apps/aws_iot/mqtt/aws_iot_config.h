...
#define AWS_IOT_MQTT_CLIENT_ID "Test_IoT" //"c-sdk-client-id" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME  "Test_IoT" ///< Thing Name of the Shadow this device is associated with
// =================================================
