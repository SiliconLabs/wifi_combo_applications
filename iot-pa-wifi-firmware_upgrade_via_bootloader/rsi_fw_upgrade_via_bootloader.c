...
//! Firmware upgrade request structure
    ...
    switch(rsi_wlan_app_cb.state)
    {
      ...
      case RSI_WLAN_FW_UPGRADE:
        {
          ...
          while(offset <= fw_image_size)
          {
            ...
            else if(chunk_cnt == chunk_check)
            {
              ...
              LOG_PRINT("\r\nTime taken for firmware upgradation using microSD card:%3.0lf secs\r\n",secs);
#elif INTERNAL_FLASH_FW

              LOG_PRINT("\r\nTime taken for firmware upgradation using EFM32's internal flash:%3.0lf secs\r\n",secs);
#endif
      ...
      case RSI_WLAN_FW_UPGRADE_DONE :
        ...
        rsi_task_create((rsi_task_function_t)rsi_wireless_driver_task,
          ...
          LOG_PRINT("\r\nFirmware version after upgradation is: %s\r\n",fw_version);
          while(1);
        }
        break;
      default:
