...
/**
 * @fn         EXTI15_10_IRQHandler
 * @brief      This function is used to process the button functionality for STM32 MCU.
 ...
 * @brief      This function is used to process the button functionality for EFR32 MCU.
 * @param[in]  GPIO_Pin, Pin number.
 * @return     none
 */
