# WLAN Throughput Demo with ThreadX RTOS
...
software maintenance. ThreadX also has a number of add-on modules (TCP/IP network stack, FAT
filesystem, GUI framework, USB stack) that can be used according to requirements.
